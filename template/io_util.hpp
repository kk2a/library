...
IStream &operator>>(IStream &, std::array<T, F> &);

template <class OStream, class T, size_t F, kk2::is_ostream_t<OStream> *>
OStream &operator<<(OStream &, const std::array<T, F> &);
