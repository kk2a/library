...
data:
  ...
  - code: "#ifndef KK2_TEMPLATE_IO_UTIL_HPP\n#define KK2_TEMPLATE_IO_UTIL_HPP 1\n\n\
    ...
    name: default
  - code: "#line 1 \"template/io_util.hpp\"\n\n\n\n#include <array>\n#include <utility>\n\
      ...
      \u304Boj verify\u306F\u30D7\u30ED\u30C8\u30BF\u30A4\u30D7\u5BA3\u8A00\u304C\u843D\
      \u3061\u308B\n\nnamespace impl {\n\nstruct read {\n    template <class IStream,\
      \ class T> inline static void all_read(IStream &is, T &x) { is >> x; }\n\n \
      \   template <class IStream, class T, class U>\n    inline static void all_read(IStream\
      \ &is, std::pair<T, U> &p) {\n        all_read(is, p.first);\n        all_read(is,\
      \ p.second);\n    }\n\n    template <class IStream, class T> inline static void\
      \ all_read(IStream &is, std::vector<T> &v) {\n        for (T &x : v) all_read(is,\
      \ x);\n    }\n\n    template <class IStream, class T, size_t F>\n    inline\
      \ static void all_read(IStream &is, std::array<T, F> &a) {\n        for (T &x\
      \ : a) all_read(is, x);\n    }\n};\n\nstruct write {\n    template <class OStream,\
      \ class T> inline static void all_write(OStream &os, const T &x) {\n       \
