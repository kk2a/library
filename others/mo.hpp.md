...
data:
  ...
  - code: "#ifndef KK2_OTHERS_MO_HPP\n#define KK2_OTHERS_MO_HPP 1\n\n#include <algorithm>\n\
      ...
      \ queries[i].second) insert_right(nowr++);\n            while (nowl < queries[i].first)\
  ...
  - code: "#line 1 \"others/mo.hpp\"\n\n\n\n#include <algorithm>\n#include <cassert>\n\
      ...
      \ <typename IL, typename IR, typename EL, typename ER, typename F>\n    void\
      \ calculate(const IL &insert_left,\n                   const IR &insert_right,\n\
      \                   const EL &erase_left,\n                   const ER &erase_right,\n\
      ...
      \ (nowr > queries[i].second) erase_right(--nowr);\n            f(i);\n     \
      \   }\n    }\n\n    template <typename I, typename E, typename F>\n    void\
      \ calculate(const I &insert, const E &erase, const F &f) {\n        calculate(insert,\
      \ insert, erase, erase, f);\n    }\n\n  private:\n    int n, q, block_size;\n\
