...
using is_integral_extended =
    typename std::conditional<std::is_integral<T>::value or
...
using is_signed_extended =
    typename std::conditional<std::is_signed<T>::value or
                              is_signed_int128<T>::value,
                              std::true_type, std::false_type>::type;

template <typename T>
using is_unsigned_extended =
    typename std::conditional<std::is_unsigned<T>::value or
                              is_unsigned_int128<T>::value,
                              std::true_type, std::false_type>::type;
