...
template <NTTFriendlyFormalPowerSeries FPS> FPS dense_inv(const FPS &f, int precision = -1) {
...
template <ArbitraryModulusFormalPowerSeries FPS> FPS dense_inv(const FPS &f, int precision = -1);
