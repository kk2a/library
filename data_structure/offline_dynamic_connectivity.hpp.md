...
data:
  ...
  - code: "#ifndef KK2_DATA_STRUCTURE_OFFLINE_DYNAMIC_CONNECTIVITY_HPP\n#define KK2_DATA_STRUCTURE_OFFLINE_DYNAMIC_CONNECTIVITY_HPP\
      ...
      \ q) return;\n            uf.snapshot();\n            for (int i = siz[now -\
      \ 1]; i < siz[now]; i++) uf.unite(seg[i].first, seg[i].second);\n          \
      \  if (now >= sz) {\n                query(now - sz);\n            } else {\n\
      \                self(self, now * 2);\n                self(self, now * 2 +\
      \ 1);\n            }\n            uf.rollback();\n        };\n        dfs(dfs,\
      \ 1);\n    }\n};\n\n\n} // namespace kk2\n\n#endif // KK2_DATA_STRUCTURE_OFFLINE_DYNAMIC_CONNECTIVITY_HPP\n"
    name: default
  - code: "#line 1 \"data_structure/offline_dynamic_connectivity.hpp\"\n\n\n\n#include\
      \ <algorithm>\n#include <unordered_map>\n#include <utility>\n#include <vector>\n\
