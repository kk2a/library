...
data:
  ...
  - code: "#ifndef KK2_GRAPH_DETAIL_DIRECT_ADJACENCY_STORAGE_HPP\n#define KK2_GRAPH_DETAIL_DIRECT_ADJACENCY_STORAGE_HPP\
    ...
    name: default
  - code: "#line 1 \"graph/detail/direct_adjacency_storage.hpp\"\n\n\n\n#include <utility>\n\
      ...
      \ v, int i, int j) { std::swap(data[v][i], data[v][j]); }\n    void add_vertex(int\
      \ n) { data.insert(data.end(), n, out_edges()); }\n\n    void reset() { data.assign(data.size(),\
      \ out_edges()); }\n\n    void reserve(const _Edges<T> &edges) {\n        const\
      \ auto degree = adjacency_degrees<T, is_directed>(num_vertices(), edges);\n\
...
documentation_of: graph/detail/direct_adjacency_storage.hpp
layout: document
---
