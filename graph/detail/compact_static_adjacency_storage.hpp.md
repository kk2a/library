...
data:
  ...
  - type_traits/io.hpp
  embedded:
  - code: "#ifndef KK2_GRAPH_DETAIL_COMPACT_STATIC_ADJACENCY_STORAGE_HPP\n#define\
      \ KK2_GRAPH_DETAIL_COMPACT_STATIC_ADJACENCY_STORAGE_HPP 1\n\n#include <span>\n\
      #include <utility>\n#include <vector>\n\n#include \"adjacency_storage_common.hpp\"\
      \n#include \"../compact_edge.hpp\"\n\nnamespace kk2::graph::detail {\n\ntemplate\
      \ <class T, bool is_directed> struct CompactStaticAdjacencyStorage {\n    using\
      ...
      \ end - head[k]), edges, k};\n    }\n    _AdjacencyView<T, true> view(const\
      \ std::vector<int> &head,\n                                 const _Edges<T>\
      \ *edges,\n                                 int k) const {\n        const int\
      \ end = k + 1 == (int)head.size() ? data.size() : head[k + 1];\n        return\
      \ {std::span<const int>(data).subspan(head[k], end - head[k]), edges, k};\n\
    ...
    name: default
  - code: "#line 1 \"graph/detail/compact_static_adjacency_storage.hpp\"\n\n\n\n#include\
...
documentation_of: graph/detail/compact_static_adjacency_storage.hpp
layout: document
---
