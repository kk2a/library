...
data:
  ...
  - code: "#ifndef KK2_CONVOLUTION_CONVOLUTION_INT_HPP\n#define KK2_CONVOLUTION_CONVOLUTION_INT_HPP\
      ...
      \ m = int(b.size());\n    if (!n || !m) return {};\n    if (detect_sparsity\
      \ && is_sparse_operation(FPSOperation::CONVOLUTION, 0, a, b)) {\n        std::vector<int>\
      \ nza, nzb;\n        nza.reserve(std::ranges::count_if(a, [](const auto &x)\
      \ { return x != 0; }));\n        nzb.reserve(std::ranges::count_if(b, [](const\
      \ auto &x) { return x != 0; }));\n        for (int i = 0; i < n; i++)\n    \
  ...
  - code: "#line 1 \"convolution/convolution_int.hpp\"\n\n\n\n#include <algorithm>\n\
      ...
      \ kk2 {\n\ntemplate <class FPS> FPS convolution_int(FPS &a, const FPS &b, bool\
