...
data:
  ...
  - code: "#line 1 \"data_structure/my_bitset.hpp\"\n\n\n\n#include <algorithm>\n\
      ...
      \ }\n};\n\n} // namespace kk2\n\n\n#line 2 \"verify/unit_test/data_structure/my_bitset.test.cpp\"\
      \n\n#line 6 \"verify/unit_test/data_structure/my_bitset.test.cpp\"\n\nint main()\
      \ {\n    for (int n : {0, 1, 63, 64, 65, 127, 128, 129}) {\n        kk2::DynamicBitSet\
      \ bits(n);\n        assert(bits.size() == n);\n        assert(bits.word_count()\
      \ == (n + 63) / 64);\n        assert(bits.popcount() == 0);\n        assert(bits.ctz()\
      \ == n);\n        assert(bits.clz() == n);\n\n        bits.set_all();\n    \
      \    assert(bits.popcount() == n);\n        if (n) {\n            assert(bits.find_next(0)\
      \ == 0);\n            assert(bits.find_prev(n - 1) == n - 1);\n        }\n \
  ...
  verifiedWith: []
documentation_of: verify/unit_test/data_structure/my_bitset.test.cpp
layout: document
---
