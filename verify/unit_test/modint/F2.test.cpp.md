...
data:
  ...
  - code: "// competitive-verifier: STANDALONE\n\n#include \"../../../modint/F2.hpp\"\
      ...
      \ == z);\n    assert(-y == y);\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/unit_test/modint/F2.test.cpp\"\n// competitive-verifier:\
      \ STANDALONE\n\n#line 1 \"modint/F2.hpp\"\n\n\n\n#include <cassert>\n\n#line\
      ...
      \ &os, const F2 &a) {\n        os << a._v;\n        return os;\n    }\n    template\
      \ <InputStream IStream> friend IStream &operator>>(IStream &is, F2 &a) {\n \
      \       bool x;\n        is >> x;\n        a = F2(x);\n        return is;\n\
      \    }\n};\n\n} // namespace kk2\n\n\n#line 4 \"verify/unit_test/modint/F2.test.cpp\"\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 6 \"verify/unit_test/modint/F2.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    kk2::F2 x, y(0), z(1);\n    assert(x\
      \ == y);\n    assert(x != z);\n    assert(y + y == y);\n    assert(z + y ==\
      \ z);\n    assert(y + z == z);\n    assert(z + z == y);\n    assert(y - y ==\
      \ y);\n    assert(z - y == z);\n    assert(z - z == y);\n    assert(z - y ==\
