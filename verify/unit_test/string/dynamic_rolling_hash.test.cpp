...
void test_performance() {
    ...
    // Test 1: Large string construction and query performance
    {
        ...
        cerr << PerformanceConfig::MANY_QUERIES << " substring queries time: " << query_time
             << " microseconds" << endl;
    }
    ...
    // Test 2: Large size construction and set operations performance
    {
        ...
        cerr << "Init_set and build time for " << n << " elements: " << init_time << " microseconds"
             << endl;
        ...
        cerr << PerformanceConfig::MANY_QUERIES << " set operations time: " << set_time
             << " microseconds" << endl;
    }
    ...
    // Test 3: Many single point queries performance
    {
        ...
        cerr << PerformanceConfig::MANY_QUERIES
             << " single point queries time: " << point_query_time << " microseconds" << endl;
    }
    ...
    // Test 4: LCP operations performance
    {
        ...
        cerr << PerformanceConfig::MEDIUM_QUERIES << " LCP operations time: " << lcp_time
             << " microseconds" << endl;
    }
    ...
    // Test 6: strcmp performance
    {
        ...
        cerr << PerformanceConfig::MEDIUM_QUERIES << " strcmp operations time: " << strcmp_time
             << " microseconds" << endl;
    }
    ...
    // Test 7: Dynamic update performance with mixed operations
    {
        ...
        cerr << PerformanceConfig::MEDIUM_QUERIES
             << " mixed set+query operations time: " << mixed_time << " microseconds" << endl;
    }
    ...
    // Test 9: all_prod() performance
    {
        ...
        cerr << PerformanceConfig::MANY_QUERIES << " all_prod() operations time: " << all_prod_time
             << " microseconds" << endl;
    }
