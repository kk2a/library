...
data:
  ...
  - code: "// competitive-verifier: STANDALONE\n\n#include \"../../../math/wheel_sieve.hpp\"\
      ...
      \n\nint main() {\n    std::vector<int> limits{0, 1, 2, 3, 29, 30, 31, 100, 1000,\
      \ 100000, 1000000};\n    for (int n : limits) {\n        auto expected = kk2::PrimeTable::primes(n).to_vec();\n\
      \        assert(kk2::wheel_sieve(n) == expected);\n    }\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/unit_test/math/wheel_sieve.test.cpp\"\n// competitive-verifier:\
      \ STANDALONE\n\n#line 1 \"math/wheel_sieve.hpp\"\n\n\n\n#include <algorithm>\n\
      ...
      \        }\n    }\n    return primes;\n}\n\n} // namespace number_theory\n\n\
      using number_theory::wheel_sieve;\n\n} // namespace kk2\n\n\n#line 4 \"verify/unit_test/math/wheel_sieve.test.cpp\"\
      \n\n#line 7 \"verify/unit_test/math/wheel_sieve.test.cpp\"\n\n#line 1 \"math/prime_table.hpp\"\
      \n\n\n\n#line 1 \"math/isprime_table.hpp\"\n\n\n\n#line 11 \"math/isprime_table.hpp\"\
      \n\n#line 14 \"math/isprime_table.hpp\"\n\nnamespace kk2 {\n\nstruct IsPrimeTable\
      \ {\n  private:\n    static constexpr std::array<int, 9> _small_primes{2, 3,\
      ...
      \ kk2\n\n\n#line 9 \"verify/unit_test/math/wheel_sieve.test.cpp\"\n\nint main()\
      \ {\n    std::vector<int> limits{0, 1, 2, 3, 29, 30, 31, 100, 1000, 100000,\
      \ 1000000};\n    for (int n : limits) {\n        auto expected = kk2::PrimeTable::primes(n).to_vec();\n\
      \        assert(kk2::wheel_sieve(n) == expected);\n    }\n    return 0;\n}\n"
    name: bundled
  isFailed: false
  ...
  verifiedWith: []
documentation_of: verify/unit_test/math/wheel_sieve.test.cpp
layout: document
---
