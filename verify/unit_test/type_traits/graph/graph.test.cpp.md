...
data:
  ...
  - code: "// competitive-verifier: STANDALONE\n\n#include <cassert>\n#include <fstream>\n\
      ...
      static_assert(std::ranges::random_access_range<decltype(std::declval<const kk2::CSAdjList\
      \ &>()[0])>);\nstatic_assert(std::same_as<decltype(std::declval<kk2::CDWAdjList<int>\
      \ &>()[0][0].cost), int &>);\nstatic_assert(std::same_as<decltype(std::declval<const\
      \ kk2::CDWAdjList<int> &>()[0][0].cost), const int &>);\nstatic_assert(std::same_as<decltype(std::declval<const\
      \ decltype(std::declval<kk2::CDWAdjList<int> &>()[0]) &>()[0].cost), const int\
  ...
  - code: "#line 1 \"verify/unit_test/type_traits/graph/graph.test.cpp\"\n// competitive-verifier:\
      ...
      \n\nnamespace kk2 {\n\nnamespace graph {\n\ntemplate <class T, bool is_directed>\n\
      using CompactAdjacencyList = detail::AdjacencyListBase<T, is_directed,\n   \
      \                                                    detail::CompactAdjacencyStorage<T,\
      \ is_directed>>;\n\n} // namespace graph\n\ntemplate <typename T> using CWAdjList\
      \ = graph::CompactAdjacencyList<T, false>;\ntemplate <typename T> using CDWAdjList\
      \ = graph::CompactAdjacencyList<T, true>;\nusing CAdjList = graph::CompactAdjacencyList<graph::empty,\
      ...
      \ is_directed, detail::CompactStaticAdjacencyStorage<T, is_directed>>;\n\n}\
      ...
      \ int>;\n};\n\n} // namespace kk2::graph\n\n\n#line 15 \"verify/unit_test/type_traits/graph/graph.test.cpp\"\
