...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0560\n\
      ...
      \        kin >> x1 >> y1 >> x2 >> y2;\n        --x1, --y1;\n        kout <<\
      \ J_ps(x1, y1, x2, y2) << \" \" << O_ps(x1, y1, x2, y2) << \" \" << I_ps(x1,\
      \ y1, x2, y2) << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: default
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002232898999992017
    environment: g++
    memory: 3.848
    name: testcase_00
    status: AC
  - elapsed: 0.00236555800000815
    environment: g++
    memory: 4.052
    name: testcase_01
    status: AC
  - elapsed: 0.005826040000002308
    environment: g++
    memory: 4.752
    name: testcase_02
    status: AC
  - elapsed: 0.019893011999997157
    environment: g++
    memory: 5.272
    name: testcase_03
    status: AC
  - elapsed: 0.021837996000002136
    environment: g++
    memory: 5.268
    name: testcase_04
    status: AC
  - elapsed: 0.09614668700000095
    environment: g++
    memory: 26.636
    name: testcase_05
    status: AC
  - elapsed: 0.10049785900000074
    environment: g++
    memory: 26.944
    name: testcase_06
    status: AC
  - elapsed: 0.10430752300000279
    environment: g++
    memory: 27.072
    name: testcase_07
    status: AC
  - elapsed: 0.10391537700000697
    environment: g++
    memory: 27.196
    name: testcase_08
    status: AC
  - elapsed: 0.10461154499999736
    environment: g++
    memory: 27.544
    name: testcase_09
    status: AC
