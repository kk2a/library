...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0560\n\
      ...
      \ I_init[i][j] = 1;\n        }\n    }\n\n    kk2::PrefixSum2D<int> J_ps(J_init),\
      \ O_ps(O_init), I_ps(I_init);\n    rep(k) {\n        int x1, y1, x2, y2;\n \
      \       kin >> x1 >> y1 >> x2 >> y2;\n        --x1, --y1;\n        kout << J_ps(x1,\
      \ y1, x2, y2) << \" \" << O_ps(x1, y1, x2, y2) << \" \" << I_ps(x1, y1, x2,\
      \ y2)\n             << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/aoj/aoj_0560.test.cpp\"\n// competitive-verifier: PROBLEM\
      \ https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0560\n\n#line 1\
      \ \"data_structure/prefix_sum_2d.hpp\"\n\n\n\n#include <cassert>\n#include <vector>\n\
      \nnamespace kk2 {\n\ntemplate <class T> struct PrefixSum2D {\n    std::vector<std::vector<T>>\
      \ acc;\n    int h, w;\n\n    constexpr PrefixSum2D() = default;\n\n    constexpr\
      \ PrefixSum2D(int h_, int w_) : acc(h_ + 1, std::vector<T>(w_ + 1)), h(h_),\
      ...
      \ > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/aoj/aoj_0560.test.cpp\"\nusing\
      \ namespace std;\n\nint main() {\n    int n, m, k;\n    kin >> n >> m >> k;\n\
      ...
      \ I_ps(I_init);\n    rep(k) {\n        int x1, y1, x2, y2;\n        kin >> x1\
      \ >> y1 >> x2 >> y2;\n        --x1, --y1;\n        kout << J_ps(x1, y1, x2,\
      \ y2) << \" \" << O_ps(x1, y1, x2, y2) << \" \" << I_ps(x1, y1, x2, y2)\n  \
      \           << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: bundled
  isFailed: false
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0025312189999908696
    environment: g++
    memory: 3.78
    name: testcase_00
    status: AC
  - elapsed: 0.0029305660000034095
    environment: g++
    memory: 3.928
    name: testcase_01
    status: AC
  - elapsed: 0.00931192099999123
    environment: g++
    memory: 4.624
    name: testcase_02
    status: AC
  - elapsed: 0.03242809099999988
    environment: g++
    memory: 5.208
    name: testcase_03
    status: AC
  - elapsed: 0.03630042899999353
    environment: g++
    memory: 5.208
    name: testcase_04
    status: AC
  - elapsed: 0.17307478200000048
    environment: g++
    memory: 26.584
    name: testcase_05
    status: AC
  - elapsed: 0.17993018399999983
    environment: g++
    memory: 26.84
    name: testcase_06
    status: AC
  - elapsed: 0.1859993229999901
    environment: g++
    memory: 26.944
    name: testcase_07
    status: AC
  - elapsed: 0.18615240100000108
    environment: g++
    memory: 27.224
    name: testcase_08
    status: AC
  - elapsed: 0.18673219100000438
    environment: g++
    memory: 27.484
    name: testcase_09
    status: AC
