...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_1_C\n\
      ...
      \  return 0;\n    }\n\n    rep (i, n) {\n        rep (j, n) {\n            if\
      \ (!dist[i][j].inf) kout << dist[i][j].len;\n            else kout << \"INF\"\
      ;\n            kout << \" \\n\"[j == n - 1];\n        }\n    }\n\n    return\
      \ 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/aoj/aoj_grl_1_c.test.cpp\"\n// competitive-verifier: PROBLEM\
      ...
      \n\n\n#include <algorithm>\n#line 6 \"graph/shortest_path/warshall_floyd.hpp\"\
      \n#include <limits>\n#line 8 \"graph/shortest_path/warshall_floyd.hpp\"\n\n\
      ...
      \ OStream>\n    void debug_output(OStream &os) const {\n        if (minf) os\
      \ << \"MINF\";\n        else if (inf) os << \"INF\";\n        else os << len;\n\
      \    }\n};\n\ntemplate <graph::WeightedEdgeListGraph WG, typename T = typename\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002045665999986568
    environment: g++
    memory: 3.844
    name: 00_sample_00
    status: AC
  - elapsed: 0.0015786440000056245
    environment: g++
    memory: 3.88
    name: 00_sample_01
    status: AC
  - elapsed: 0.0015702259999841317
    environment: g++
    memory: 3.72
    name: 00_sample_02
    status: AC
  - elapsed: 0.0015645569999946929
    environment: g++
    memory: 3.884
    name: 01_small_00
    status: AC
  - elapsed: 0.001522063000010121
    environment: g++
    memory: 3.892
    name: 01_small_01
    status: AC
  - elapsed: 0.0015621029999977054
    environment: g++
    memory: 3.852
    name: 02_corner_00
    status: AC
  - elapsed: 0.0015470459999846753
    environment: g++
    memory: 3.832
    name: 02_corner_01
    status: AC
  - elapsed: 0.0015370550000000094
    environment: g++
    memory: 3.852
    name: 02_corner_02
    status: AC
  - elapsed: 0.0015138459999946008
    environment: g++
    memory: 3.844
    name: 02_corner_03
    status: AC
  - elapsed: 0.0015392829999996138
    environment: g++
    memory: 3.892
    name: 02_corner_04
    status: AC
  - elapsed: 0.0015474170000118193
    environment: g++
    memory: 3.844
    name: 02_corner_05
    status: AC
  - elapsed: 0.0015499699999850236
    environment: g++
    memory: 3.92
    name: 02_corner_06
    status: AC
  - elapsed: 0.0015166099999817106
    environment: g++
    memory: 3.852
    name: 03_medium_00
    status: AC
  - elapsed: 0.0015198840000039127
    environment: g++
    memory: 3.892
    name: 03_medium_01
    status: AC
  - elapsed: 0.00150984999999082
    environment: g++
    memory: 3.84
    name: 04_dag_00
    status: AC
  - elapsed: 0.0017168109999943226
    environment: g++
    memory: 3.852
    name: 04_dag_01
    status: AC
  - elapsed: 0.002050464999996393
    environment: g++
    memory: 3.844
    name: 04_dag_02
    status: AC
  - elapsed: 0.0034425009999949907
    environment: g++
    memory: 3.964
    name: 04_dag_03
    status: AC
  - elapsed: 0.004349278000006507
    environment: g++
    memory: 4.02
    name: 04_dag_04
    status: AC
  - elapsed: 0.0015846019999798955
    environment: g++
    memory: 3.912
    name: 05_ring_00
    status: AC
  - elapsed: 0.0022762950000014825
    environment: g++
    memory: 3.884
    name: 05_ring_01
    status: AC
  - elapsed: 0.004059250000011616
    environment: g++
    memory: 4.02
    name: 05_ring_02
    status: AC
  - elapsed: 0.0032721750000064276
    environment: g++
    memory: 4.04
    name: 05_ring_03
    status: AC
  - elapsed: 0.002730708000001414
    environment: g++
    memory: 3.98
    name: 05_ring_04
    status: AC
  - elapsed: 0.0014959789999977602
    environment: g++
    memory: 3.72
    name: 06_grid_00
    status: AC
  - elapsed: 0.0015308810000078665
    environment: g++
    memory: 3.848
    name: 06_grid_01
    status: AC
  - elapsed: 0.001976993999988963
    environment: g++
    memory: 3.72
    name: 06_grid_02
    status: AC
  - elapsed: 0.0025204110000061064
    environment: g++
    memory: 3.98
    name: 06_grid_03
    status: AC
  - elapsed: 0.0033729969999853893
    environment: g++
    memory: 3.964
    name: 06_grid_04
    status: AC
  - elapsed: 0.0015095290000033401
    environment: g++
    memory: 3.84
    name: 07_complete_00
    status: AC
  - elapsed: 0.0018098719999954938
    environment: g++
    memory: 3.844
    name: 07_complete_01
    status: AC
  - elapsed: 0.005401722000016207
    environment: g++
    memory: 3.98
    name: 07_complete_02
    status: AC
  - elapsed: 0.008856417999993482
    environment: g++
    memory: 4.136
    name: 07_complete_03
    status: AC
  - elapsed: 0.015384772000004432
    environment: g++
    memory: 4.228
    name: 07_complete_04
    status: AC
  - elapsed: 0.001633255999990979
    environment: g++
    memory: 3.88
    name: 08_random_00
    status: AC
  - elapsed: 0.001964052999994692
    environment: g++
    memory: 3.852
    name: 08_random_01
    status: AC
  - elapsed: 0.0016780430000267188
    environment: g++
    memory: 3.872
    name: 08_random_02
    status: AC
  - elapsed: 0.00222052999998823
    environment: g++
    memory: 3.884
    name: 08_random_03
    status: AC
  - elapsed: 0.002540874000004578
    environment: g++
    memory: 3.892
    name: 08_random_04
    status: AC
  - elapsed: 0.0021320570000114003
    environment: g++
    memory: 3.852
    name: 08_random_05
    status: AC
  - elapsed: 0.002629807999994682
    environment: g++
    memory: 3.96
    name: 08_random_06
    status: AC
  - elapsed: 0.005147620000002462
    environment: g++
    memory: 3.98
    name: 08_random_07
    status: AC
  - elapsed: 0.010553845000004003
    environment: g++
    memory: 4.032
    name: 08_random_08
    status: AC
  - elapsed: 0.005473950999999033
    environment: g++
    memory: 4.108
    name: 09_maximum_00
    status: AC
  - elapsed: 0.005438457999986213
    environment: g++
    memory: 4.092
    name: 09_maximum_01
    status: AC
  - elapsed: 0.015954170000014756
    environment: g++
    memory: 4.288
    name: 09_maximum_02
    status: AC
  - elapsed: 0.007856962000005296
    environment: g++
    memory: 4.092
    name: 09_maximum_03
    status: AC
  - elapsed: 0.015848395999995546
    environment: g++
    memory: 3.904
    name: 09_maximum_04
    status: AC
  - elapsed: 0.013231914000016332
    environment: g++
    memory: 4.024
    name: 09_maximum_05
    status: AC
  - elapsed: 0.005145281000011437
    environment: g++
    memory: 4.16
    name: 09_maximum_06
    status: AC
