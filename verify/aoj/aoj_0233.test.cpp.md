...
data:
  ...
  - type_traits/io.hpp
  embedded:
  - code: "// competitive-verifier: PROBLEM https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0233\n\
      ...
      \     kout << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/aoj/aoj_0233.test.cpp\"\n// competitive-verifier: PROBLEM\
      \ https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0233\n\n#line 1\
      \ \"math/convert_base.hpp\"\n\n\n\n#include <algorithm>\n#include <cassert>\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/aoj/aoj_0233.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    while (1) {\n        int n;\n  \
      \      kin >> n;\n        if (n == 0) break;\n        auto b = kk2::convert_base<int>(n,\
      \ -10);\n        reverse(all(b));\n        for (auto a : b) kout << a;\n   \
      \     kout << \"\\n\";\n    }\n\n    return 0;\n}\n"
