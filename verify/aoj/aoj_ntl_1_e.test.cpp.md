...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_1_E\n\
      ...
      \ if (sum2 < sum1) kout << x2 << \" \" << y2 << kendl;\n    else {\n       \
      \ if (x1 <= y1) kout << x1 << \" \" << y1 << kendl;\n        else kout << x2\
      \ << \" \" << y2 << kendl;\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/aoj/aoj_ntl_1_e.test.cpp\"\n// competitive-verifier: PROBLEM\
      \ https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_1_E\n\n#line\
      \ 1 \"math/inv_gcd.hpp\"\n\n\n\n#include <algorithm>\n#include <utility>\n\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/aoj/aoj_ntl_1_e.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    int a, b;\n    kin >> a >> b;\n\
      \    auto [g, x1] = kk2::inv_gcd(a, b);\n    a /= g, b /= g;\n    i64 y1 = (1ll\
      \ - x1 * a) / b;\n    i64 sum1 = x1 + abs(y1);\n    i64 y2 = y1 % a;\n    if\
      \ (y2 < 0) y2 += a;\n    i64 x2 = (1ll - y2 * b) / a;\n    i64 sum2 = abs(x2)\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0026422589999981483
    environment: g++
    memory: 3.728
    name: 00_sample_00
    status: AC
  - elapsed: 0.002349087999988342
    environment: g++
    memory: 3.748
    name: 00_sample_01
    status: AC
  - elapsed: 0.0023362989999924366
    environment: g++
    memory: 3.72
    name: 01_small_00
    status: AC
  - elapsed: 0.002288315000001262
    environment: g++
    memory: 3.716
    name: 01_small_01
    status: AC
  - elapsed: 0.002293483999991963
    environment: g++
    memory: 3.764
    name: 01_small_02
    status: AC
  - elapsed: 0.0022689269999887074
    environment: g++
    memory: 3.756
    name: 01_small_03
    status: AC
  - elapsed: 0.0022510799999935216
    environment: g++
    memory: 3.72
    name: 01_small_04
    status: AC
  - elapsed: 0.002297033999994369
    environment: g++
    memory: 3.712
    name: 01_small_05
    status: AC
  - elapsed: 0.002253061999994088
    environment: g++
    memory: 3.736
    name: 02_critical_00
    status: AC
  - elapsed: 0.0022565539999988005
    environment: g++
    memory: 3.72
    name: 02_critical_01
    status: AC
  - elapsed: 0.0022814109999984566
    environment: g++
    memory: 3.712
    name: 02_critical_02
    status: AC
  - elapsed: 0.0023056320000023334
    environment: g++
    memory: 3.7
    name: 02_critical_03
    status: AC
  - elapsed: 0.002276068000000464
    environment: g++
    memory: 3.684
    name: 03_large_00
    status: AC
  - elapsed: 0.002219213000003606
    environment: g++
    memory: 3.716
    name: 03_large_01
    status: AC
  - elapsed: 0.002270293999998785
    environment: g++
    memory: 3.7
    name: 03_large_02
    status: AC
  - elapsed: 0.0022814659999994547
    environment: g++
    memory: 3.728
    name: 03_large_03
    status: AC
  - elapsed: 0.002256368000004727
    environment: g++
    memory: 3.696
    name: 03_large_04
    status: AC
  - elapsed: 0.0022408439999992424
    environment: g++
    memory: 3.696
    name: 03_large_05
    status: AC
  - elapsed: 0.0022595730000034564
    environment: g++
    memory: 3.7
    name: 03_large_06
    status: AC
  - elapsed: 0.0022435780000051864
    environment: g++
    memory: 3.66
    name: 03_large_07
    status: AC
  - elapsed: 0.0022440589999916938
    environment: g++
    memory: 3.732
    name: 03_large_08
    status: AC
  - elapsed: 0.0022562369999974408
    environment: g++
    memory: 3.74
    name: 03_large_09
    status: AC
  - elapsed: 0.0022789920000008124
    environment: g++
    memory: 3.728
    name: 04_corner_00
    status: AC
  - elapsed: 0.0022352459999979146
    environment: g++
    memory: 3.7
    name: 04_corner_01
    status: AC
  - elapsed: 0.0024097430000011855
    environment: g++
    memory: 3.752
    name: 04_corner_02
    status: AC
  - elapsed: 0.0022742000000022244
    environment: g++
    memory: 3.728
    name: 04_corner_03
    status: AC
  - elapsed: 0.0022515699999985372
    environment: g++
    memory: 3.764
    name: 05_rand_00
    status: AC
  - elapsed: 0.002217408999996451
    environment: g++
    memory: 3.716
    name: 05_rand_01
    status: AC
  - elapsed: 0.0023333689999986973
    environment: g++
    memory: 3.688
    name: 05_rand_02
    status: AC
  - elapsed: 0.002265100999991887
    environment: g++
    memory: 3.72
    name: 05_rand_03
    status: AC
  - elapsed: 0.0023040299999905756
    environment: g++
    memory: 3.7
    name: 05_rand_04
    status: AC
  - elapsed: 0.0022558069999973895
    environment: g++
    memory: 3.74
    name: 05_rand_05
    status: AC
