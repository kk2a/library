...
data:
  ...
  - code: "#line 1 \"verify/yosupo_string/string_number_of_substrings.test.cpp\"\n\
      ...
      \ buf(upper + 1);\n            std::copy(std::begin(sum_s), std::end(sum_s),\
      \ std::begin(buf));\n            for (auto d : lms) {\n                if (d\
      \ == n) continue;\n                sa[buf[s[d]]++] = d;\n            }\n   \
      ...
      \ std::vector<int> rec_sa = sa_is<THRESHOLD_NAIVE, THRESHOLD_DOUBLING>(rec_s,\
      \ rec_upper);\n\n            for (int i = 0; i < m; i++) { sorted_lms[i] = lms[rec_sa[i]];\
      \ }\n            induce(sorted_lms);\n        }\n        return sa;\n    }\n\
      \n    void init() { _sa = sa_is(_s, _upper); }\n};\n\nstruct LCPArray {\n  \
      \  const SuffixArray &sa;\n    std::vector<int> lcp, rank;\n\n    // lcp[i]\
      \ = lcp(s[sa[i]:], s[sa[i + 1]:])\n\n    LCPArray(const SuffixArray &sa_) :\
      \ sa(sa_) {\n        lcp.resize(sa.size());\n        rank.resize(sa.size());\n\
      \        for (int i = 0; i < sa.size(); ++i) rank[sa[i]] = i;\n        const\
      \ std::vector<int> &s = sa.get_s();\n        lcp[sa.size() - 1] = 0;\n     \
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.22674845400000265
    environment: g++
    memory: 11.796
    name: all_same_00
    status: AC
  - elapsed: 0.22977824900000599
    environment: g++
    memory: 11.828
    name: all_same_01
    status: AC
  - elapsed: 0.2299495829999998
    environment: g++
    memory: 11.828
    name: all_same_02
    status: AC
  - elapsed: 0.22622280200000233
    environment: g++
    memory: 11.764
    name: all_same_03
    status: AC
  - elapsed: 0.22646786600000013
    environment: g++
    memory: 11.792
    name: all_same_04
    status: AC
  - elapsed: 0.0018725540000019691
    environment: g++
    memory: 3.864
    name: example_00
    status: AC
  - elapsed: 0.0018177030000003924
    environment: g++
    memory: 3.852
    name: example_01
    status: AC
  - elapsed: 0.001955045999999072
    environment: g++
    memory: 3.84
    name: example_02
    status: AC
  - elapsed: 0.0018141979999981572
    environment: g++
    memory: 3.86
    name: example_03
    status: AC
  - elapsed: 0.3779504299999985
    environment: g++
    memory: 15.264
    name: fib_str_00
    status: AC
  - elapsed: 0.2681495459999965
    environment: g++
    memory: 12.068
    name: fib_str_01
    status: AC
  - elapsed: 0.308251147
    ...
    name: fib_str_02
    status: AC
  - elapsed: 0.19794040600000073
    environment: g++
    memory: 10.032
    name: fib_str_03
    status: AC
  - elapsed: 0.39286942400000413
    environment: g++
    memory: 15.988
    name: fib_str_04
    status: AC
  - elapsed: 0.4018903179999995
    environment: g++
    memory: 15.94
    name: max_random_00
    status: AC
  - elapsed: 0.40234295300000156
    environment: g++
    memory: 16.028
    name: max_random_01
    status: AC
  - elapsed: 0.402339211999994
    environment: g++
    memory: 16.028
    name: max_random_02
    status: AC
  - elapsed: 0.40094973800000133
    environment: g++
    memory: 16.056
    name: max_random_03
    status: AC
  - elapsed: 0.39765389600000134
    environment: g++
    memory: 15.972
    name: max_random_04
    status: AC
  - elapsed: 0.3134197430000043
    environment: g++
    memory: 13.428
    name: random_00
    status: AC
  - elapsed: 0.38068283499999467
    environment: g++
    memory: 15.284
    name: random_01
    status: AC
  - elapsed: 0.041379476000003024
    environment: g++
    memory: 4.788
    name: random_02
    status: AC
  - elapsed: 0.3465852950000041
    environment: g++
    memory: 14.332
    name: random_03
    status: AC
  - elapsed: 0.21690162600000207
    environment: g++
    memory: 10.536
    name: random_04
    status: AC
