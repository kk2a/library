...
data:
  ...
  - type_traits/io.hpp
  embedded:
  - code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/430\n\
  ...
  - code: "#line 1 \"verify/yuki/yuki_0430_2.test.cpp\"\n// competitive-verifier:\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/yuki/yuki_0430_2.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    string s;\n    kin >> s;\n    int\
      \ m;\n    kin >> m;\n    vc<string> c(m);\n    kin >> c;\n\n    kk2::AhoCorasick<26,\
      \ 'A'> ac(100000);\n    for (auto &x : c) ac.add(x);\n    ac.build();\n    auto\
      \ each = ac.each_match(s);\n    i64 res = accumulate(all(each), 0LL);\n    kout\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0023414249999973435
    environment: g++
    memory: 3.78
    name: challenge01
    status: AC
  - elapsed: 0.015271421000008445
    environment: g++
    memory: 7.312
    name: challenge02
    status: AC
  - elapsed: 0.009938572999999451
    environment: g++
    memory: 4.748
    name: challenge03
    status: AC
  - elapsed: 0.009917782000002262
    environment: g++
    memory: 4.76
    name: challenge04
    status: AC
  - elapsed: 0.0018166440000015882
    environment: g++
    memory: 3.72
    name: sample1
    status: AC
  - elapsed: 0.0018035950000125922
    environment: g++
    memory: 3.916
    name: sample2
    status: AC
  - elapsed: 0.0017761630000023843
    environment: g++
    memory: 3.856
    name: sample3
    status: AC
  - elapsed: 0.001756485000001362
    environment: g++
    memory: 3.78
    name: sample4
    status: AC
  - elapsed: 0.003832024000004708
    environment: g++
    memory: 4.012
    name: test1
    status: AC
  - elapsed: 0.011123147000006384
    environment: g++
    memory: 7.144
    name: test10
    status: AC
  - elapsed: 0.002239232999997398
    environment: g++
    memory: 3.984
    name: test2
    status: AC
  - elapsed: 0.0020572920000034856
    environment: g++
    memory: 3.852
    name: test3
    status: AC
  - elapsed: 0.012958088000004864
    environment: g++
    memory: 7.216
    name: test4
    status: AC
  - elapsed: 0.01384932499999536
    environment: g++
    memory: 7.184
    name: test5
    status: AC
  - elapsed: 0.01431101100000376
    environment: g++
    memory: 7.18
    name: test6
    status: AC
  - elapsed: 0.012812440999994124
    environment: g++
    memory: 7.232
    name: test7
    status: AC
  - elapsed: 0.011627247000006946
    environment: g++
    memory: 7.128
    name: test8
    status: AC
  - elapsed: 0.011361950999997816
    environment: g++
    memory: 7.16
    name: test9
    status: AC
