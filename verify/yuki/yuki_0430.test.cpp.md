...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/430\n\
    ...
    name: default
  - code: "#line 1 \"verify/yuki/yuki_0430.test.cpp\"\n// competitive-verifier: PROBLEM\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/yuki/yuki_0430.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    string s;\n    kin >> s;\n    int\
      \ m;\n    kin >> m;\n    vc<string> c(m);\n    kin >> c;\n\n    kk2::AhoCorasick<26,\
      \ 'A'> ac(100000);\n    for (auto &x : c) ac.add(x);\n    ac.build();\n    kout\
      \ << ac.all_match(s) << kendl;\n\n    return 0;\n}\n"
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002342978999990919
    environment: g++
    memory: 3.916
    name: challenge01
    status: AC
  - elapsed: 0.018458717000001457
    environment: g++
    memory: 7.296
    name: challenge02
    status: AC
  - elapsed: 0.011385981000003653
    environment: g++
    memory: 4.732
    name: challenge03
    status: AC
  - elapsed: 0.011291029999995317
    environment: g++
    memory: 4.736
    name: challenge04
    status: AC
  - elapsed: 0.0017873319999921478
    environment: g++
    memory: 3.916
    name: sample1
    status: AC
  - elapsed: 0.0017557759999959899
    environment: g++
    memory: 3.804
    name: sample2
    status: AC
  - elapsed: 0.0017900859999997465
    environment: g++
    memory: 3.88
    name: sample3
    status: AC
  - elapsed: 0.0017750650000039059
    environment: g++
    memory: 3.872
    name: sample4
    status: AC
  - elapsed: 0.007242367999992894
    environment: g++
    memory: 3.988
    name: test1
    status: AC
  - elapsed: 0.01285227500000019
    environment: g++
    memory: 7.02
    name: test10
    status: AC
  - elapsed: 0.00231730199999447
    environment: g++
    memory: 3.988
    name: test2
    status: AC
  - elapsed: 0.0023493500000029144
    environment: g++
    memory: 3.864
    name: test3
    status: AC
  - elapsed: 0.017698964999993905
    environment: g++
    memory: 7.696
    name: test4
    status: AC
  - elapsed: 0.018743030999999633
    environment: g++
    memory: 7.724
    name: test5
    status: AC
  - elapsed: 0.01832033099999819
    environment: g++
    memory: 7.7
    name: test6
    status: AC
  - elapsed: 0.015965121999997223
    environment: g++
    memory: 7.336
    name: test7
    status: AC
  - elapsed: 0.014444245999996497
    environment: g++
    memory: 7.156
    name: test8
    status: AC
  - elapsed: 0.013183949000008965
    environment: g++
    memory: 7.032
    name: test9
    status: AC
