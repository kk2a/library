...
data:
  ...
  - code: "#line 1 \"verify/yuki/yuki_1510.test.cpp\"\n// #define PROBLEM \"https://yukicoder.me/problems/no/1510\"\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 8 \"verify/yuki/yuki_1510.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\n\n// \\\
      int_{-infty}^{infty} (x^2 + A^2)^-n dx\n// = pi / A^{2n-1} * binom(2n-2, n-1)\
      \ * 2^{-2n+2}\n//\n// binom(2n-2, n-1) * 2^{-2n+2} = (2n-3)!! / (2n-2)!! (n\
      \ > 1)\nint main() {\n    int a, b;\n    kin >> a >> b;\n    kout << a + b <<\
      \ kendl;\n\n    return 0;\n}\n"
    name: bundled
  isFailed: false
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0026158089999910317
    environment: g++
    memory: 3.684
    name: example_00
    status: AC
  - elapsed: 0.0021229740000023867
    environment: g++
    memory: 3.692
    name: example_01
    status: AC
  - elapsed: 0.0020793729999866173
    environment: g++
    memory: 3.692
    name: random_00
    status: AC
  - elapsed: 0.0020857639999860567
    environment: g++
    memory: 3.676
    name: random_01
    status: AC
  - elapsed: 0.00227976300001842
    environment: g++
    memory: 3.628
    name: random_02
    status: AC
  - elapsed: 0.0020800480000104926
    environment: g++
    memory: 3.72
    name: random_03
    status: AC
  - elapsed: 0.0020743800000104784
    environment: g++
    memory: 3.708
    name: random_04
    status: AC
  - elapsed: 0.0020904339999958665
    environment: g++
    memory: 3.708
    name: random_05
    status: AC
  - elapsed: 0.0020758029999967675
    environment: g++
    memory: 3.704
    name: random_06
    status: AC
  - elapsed: 0.0020938700000101562
    environment: g++
    memory: 3.724
    name: random_07
    status: AC
  - elapsed: 0.002132893000009517
    environment: g++
    memory: 3.724
    name: random_08
    status: AC
  - elapsed: 0.002109769999975697
    environment: g++
    memory: 3.748
    name: random_09
    status: AC
