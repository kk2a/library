...
data:
  ...
  bundledCode: "#line 1 \"verify/yuki/yuki_1510.test.cpp\"\n// #define PROBLEM \"\
    ...
    \ ret[i] *= -a[i] * prod;\n    return ret;\n}\n\n// f(X) / \\prod (X - a_i)^d_i\
    \ =  \\sum c_i,j / (X - a_i)^j\n// return {c_i,j}\ntemplate <class FPS, class\
    \ mint = typename FPS::value_type> std::vector<std::vector<mint>>\nBBB(const std::vector<mint>\
    \ &a, const std::vector<mint> &d, const FPS &f) {\n    // hoge\n}\n\n} // namespace\
