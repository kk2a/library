...
data:
  ...
  - code: "#line 1 \"verify/yuki/yuki_1326.test.cpp\"\n// competitive-verifier: PROBLEM\
      ...
      \ 5 \"graph/tree/block_cut_tree.hpp\"\n\n#line 1 \"graph/bcc.hpp\"\n\n\n\n#include\
      ...
      \            sz[now] = 1;\n            for (auto &e : g[now]) {\n          \
      \      if ((int)e == par[now]) {\n                    if (g[now].size() >= 2\
      \ and e == g[now][0]) std::swap(e, g[now][1]);\n                    else continue;\n\
      \                }\n                par[(int)e] = now;\n                dep[(int)e]\
      \ = dep[now] + 1;\n                self(self, (int)e);\n                sz[now]\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002342616999996494
    environment: g++
    memory: 3.868
    name: size_1__sample_1
    status: AC
  - elapsed: 0.0018533990000122458
    environment: g++
    memory: 3.916
    name: size_1_gen_1
    status: AC
  - elapsed: 0.002252442999989057
    environment: g++
    memory: 3.868
    name: size_1_gen_2
    status: AC
  - elapsed: 0.0024010340000018005
    environment: g++
    memory: 3.872
    name: size_1_gen_3
    status: AC
  - elapsed: 0.0025946819999944637
    environment: g++
    memory: 4.036
    name: size_1_gen_4
    status: AC
  - elapsed: 0.0017934290000027886
    environment: g++
    memory: 3.912
    name: size_1_hand_1
    status: AC
  - elapsed: 0.0018114069999910498
    environment: g++
    memory: 3.884
    name: size_1_hand_2
    status: AC
  - elapsed: 0.005115904999996701
    environment: g++
    memory: 4.308
    name: size_2_gen_1
    status: AC
  - elapsed: 0.005324215000001686
    environment: g++
    memory: 4.264
    name: size_2_gen_2
    status: AC
  - elapsed: 0.004933923999999479
    environment: g++
    memory: 4.308
    name: size_2_gen_3
    status: AC
  - elapsed: 0.006027451999997879
    environment: g++
    memory: 4.432
    name: size_2_gen_4
    status: AC
  - elapsed: 0.005947641999995312
    environment: g++
    memory: 4.452
    name: size_2_gen_tree_1
    status: AC
  - elapsed: 0.24159786999999255
    environment: g++
    memory: 25.748
    name: size_3_gen_1
    status: AC
  - elapsed: 0.23641654800000822
    environment: g++
    memory: 25.828
    name: size_3_gen_2
    status: AC
  - elapsed: 0.23615303599999038
    environment: g++
    memory: 25.748
    name: size_3_gen_3
    status: AC
  - elapsed: 0.2348091350000061
    environment: g++
    memory: 25.696
    name: size_3_gen_4
    status: AC
  - elapsed: 0.22733280699999625
    environment: g++
    memory: 25.232
    name: size_3_gen_5
    status: AC
  - elapsed: 0.18364309700000092
    environment: g++
    memory: 20.396
    name: size_3_gen_6
    status: AC
  - elapsed: 0.17925805899999148
    environment: g++
    memory: 19.044
    name: size_3_gen_7
    status: AC
  - elapsed: 0.12403749499999606
    environment: g++
    memory: 18.484
    name: size_3_gen_big_cycle_1
    status: AC
  - elapsed: 0.2644042799999937
    environment: g++
    memory: 36.452
    name: size_3_gen_large_ans_1
    status: AC
  - elapsed: 0.2581698970000019
    environment: g++
    memory: 36.596
    name: size_3_gen_line_1
    status: AC
  - elapsed: 0.2994660100000033
    environment: g++
    memory: 41.828
    name: size_3_gen_line_clique_1
    status: AC
  - elapsed: 0.1794536759999943
    environment: g++
    memory: 21.368
    name: size_3_gen_star_1
    status: AC
  - elapsed: 0.24112577899998655
    environment: g++
    memory: 25.764
