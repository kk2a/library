...
data:
  ...
  dependsOn: []
  embedded:
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/longest_increasing_subsequence\n\
      ...
      \ 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_others/longest_increasing_subsequence.test.cpp\"\
      \n// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/longest_increasing_subsequence\n\
      \n#line 1 \"others/longest_increasing_subsequence.hpp\"\n\n\n\n#include <algorithm>\n\
      #include <utility>\n#include <vector>\n\nnamespace kk2 {\n\n// return indices\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/yosupo_others/longest_increasing_subsequence.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    int n;\n    kin >> n;\n    vc<int>\
      \ a(n);\n    kin >> a;\n    auto res = kk2::longest_increasing_subsequence(a);\n\
      \    kout << res.size() << \"\\n\";\n    kout << res << \"\\n\";\n\n    return\
      \ 0;\n}\n"
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0027663999999845146
    environment: g++
    memory: 3.584
    name: example_00
    status: AC
  - elapsed: 0.0022389979999957177
    environment: g++
    memory: 3.632
    name: example_01
    status: AC
  - elapsed: 0.34412814999998886
    environment: g++
    memory: 15.352
    name: hand_max_00
    status: AC
  - elapsed: 0.11271507400002179
    environment: g++
    memory: 7.292
    name: hand_min_00
    status: AC
  - elapsed: 0.25236857199999463
    environment: g++
    memory: 7.464
    name: max_random_00
    status: AC
  - elapsed: 0.25308582499999943
    environment: g++
    memory: 7.408
    name: max_random_01
    status: AC
  - elapsed: 0.2534188980000067
    environment: g++
    memory: 7.456
    name: max_random_02
    status: AC
  - elapsed: 0.25418312100001117
    environment: g++
    memory: 7.424
    name: max_random_03
    status: AC
  - elapsed: 0.2527942729999779
    environment: g++
    memory: 7.464
    name: max_random_04
    status: AC
  - elapsed: 0.19606277700000874
    environment: g++
    memory: 6.568
    name: random_00
    status: AC
  - elapsed: 0.2338865210000165
    environment: g++
    memory: 7.08
    name: random_01
    status: AC
  - elapsed: 0.02717351100000087
    environment: g++
    memory: 3.828
    name: random_02
    status: AC
  - elapsed: 0.21756862699999147
    environment: g++
    memory: 6.824
    name: random_03
    status: AC
  - elapsed: 0.13733020399999418
    environment: g++
    memory: 5.616
    name: random_04
    status: AC
  - elapsed: 0.0025003549999951247
    environment: g++
    memory: 3.632
    name: small_00
    status: AC
  - elapsed: 0.0022728889999825697
    environment: g++
    memory: 3.576
    name: small_01
    status: AC
  - elapsed: 0.0023180450000097608
    environment: g++
    memory: 3.632
    name: small_02
    status: AC
  - elapsed: 0.0022794690000011997
    environment: g++
    memory: 3.78
    name: small_03
    status: AC
  - elapsed: 0.0022300949999873865
    environment: g++
    memory: 3.736
    name: small_04
    status: AC
