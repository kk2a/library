...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/many_aplusb\n\
      ...
      n\";\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_others/many_a_plus_b.test.cpp\"\n// competitive-verifier:\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.5235443789999863
    environment: g++
    memory: 4.012
    name: all_max_00
    status: AC
  - elapsed: 0.081265075999994
    environment: g++
    memory: 3.968
    name: all_zero_00
    status: AC
  - elapsed: 0.3318920979999973
    environment: g++
    memory: 4.02
    name: digit_random_00
    status: AC
  - elapsed: 0.3297093930000017
    environment: g++
    memory: 3.972
    name: digit_random_01
    status: AC
  - elapsed: 0.002769775000018626
    environment: g++
    memory: 3.692
    name: example_00
    status: AC
  - elapsed: 0.5154087330000152
    environment: g++
    memory: 3.996
    name: max_random_00
    status: AC
  - elapsed: 0.5104313349999927
    environment: g++
    memory: 3.94
    name: max_random_01
    status: AC
  - elapsed: 0.2032351100000085
    environment: g++
    memory: 3.936
    name: random_00
    status: AC
  - elapsed: 0.23802305399999568
    environment: g++
    memory: 3.972
    name: random_01
    status: AC
