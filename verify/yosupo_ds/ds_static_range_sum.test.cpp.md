...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/static_range_sum\n\
      ...
      \ r) << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_ds/ds_static_range_sum.test.cpp\"\n// competitive-verifier:\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0027390340000010838
    environment: g++
    memory: 3.764
    name: example_00
    status: AC
  - elapsed: 0.1997650330000056
    environment: g++
    memory: 11.388
    name: max_random_00
    status: AC
  - elapsed: 0.20173059999996212
    environment: g++
    memory: 11.428
    name: max_random_01
    status: AC
  - elapsed: 0.20013385499999004
    environment: g++
    memory: 11.424
    name: max_random_02
    status: AC
  - elapsed: 0.20072428400004583
    environment: g++
    memory: 11.424
    name: max_random_03
    status: AC
  - elapsed: 0.20300542800003996
    environment: g++
    memory: 11.424
    name: max_random_04
    status: AC
  - elapsed: 0.16257945300003485
    environment: g++
    memory: 9.66
    name: random_00
    status: AC
  - elapsed: 0.17073865499997964
    environment: g++
    memory: 10.78
    name: random_01
    status: AC
  - elapsed: 0.10896915000000718
    environment: g++
    memory: 4.512
    name: random_02
    status: AC
  - elapsed: 0.05700475800000504
    environment: g++
    memory: 10.28
    name: random_03
    status: AC
  - elapsed: 0.06120467400000962
    environment: g++
    memory: 7.884
    name: random_04
    status: AC
