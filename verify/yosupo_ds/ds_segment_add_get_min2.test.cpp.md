...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/segment_add_get_min\n\
      ...
      \  else kout << \"INFINITY\\n\";\n        }\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_ds/ds_segment_add_get_min2.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/segment_add_get_min\n\n#line 1 \"\
      segment_tree/li_chao_tree.hpp\"\n\n\n\n#include <algorithm>\n#include <cassert>\n\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.1778290770000126
    environment: g++
    memory: 17.62
    name: all_intersect_00
    status: AC
  - elapsed: 0.7784206350000318
    environment: g++
    memory: 31.888
    name: all_twice_00
    status: AC
  - elapsed: 0.0027011930000071516
    environment: g++
    memory: 3.808
    name: example_00
    status: AC
  - elapsed: 0.002222673999995095
    environment: g++
    memory: 3.832
    name: example_01
    status: AC
  - elapsed: 0.8431622240000252
    environment: g++
    memory: 24.824
    name: max_random_00
    status: AC
  - elapsed: 0.8446610319999763
    environment: g++
    memory: 24.824
    name: max_random_01
    status: AC
  - elapsed: 0.830612771999995
    environment: g++
    memory: 24.828
    name: max_random_02
    status: AC
  - elapsed: 0.22105100499999253
    environment: g++
    memory: 17.616
    name: no_output_00
    status: AC
  - elapsed: 0.5658943459999932
    environment: g++
    memory: 20.496
    name: random_00
    status: AC
  - elapsed: 0.604873294000015
    environment: g++
    memory: 21.168
    name: random_01
    status: AC
  - elapsed: 0.34155103899996675
    environment: g++
    memory: 13.76
    name: random_02
    status: AC
  - elapsed: 0.002644745999987208
    environment: g++
    memory: 3.788
    name: small_00
    status: AC
  - elapsed: 0.002232422000020051
    environment: g++
    memory: 3.664
    name: small_01
    status: AC
