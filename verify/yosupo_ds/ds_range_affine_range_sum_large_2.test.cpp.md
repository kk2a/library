...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_ds/ds_range_affine_range_sum_large_2.test.cpp\"\
    ...
    \                                     A::A::op,\n                            \
    \                                A::A::unit>;\n\n} // namespace kk2\n\n\n#line\
    \ 1 \"math/action/affine_sumwithsize.hpp\"\n\n\n\n#line 1 \"math/group/sum_with_size.hpp\"\
    ...
    \ static S act(A f, S x) { return S(f.a * x.a + f.b * x.size, x.size); }\n};\n\
    ...
    \ A = kk2::action::AffineSumWithSize<mint, mint>;\n    int n, q;\n    kin >> n\
...
layout: document
redirect_from:
- /verify/verify/yosupo_ds/ds_range_affine_range_sum_large_2.test.cpp
- /verify/verify/yosupo_ds/ds_range_affine_range_sum_large_2.test.cpp.html
