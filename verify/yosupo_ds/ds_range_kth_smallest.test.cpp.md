...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/range_kth_smallest\n\
      ...
      \ r, k) << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_ds/ds_range_kth_smallest.test.cpp\"\n// competitive-verifier:\
      ...
      \ const { return (bits[i / B] >> (i % B)) & 1; }\n\n    inline int rank0(int\
      \ i) const { return i - rank1(i); }\n\n    inline int rank1(int i) const {\n\
      \        return count[i / B] + popcount(bits[i / B] & ((Uint(1) << (i % B))\
      ...
      \ i = lg - 1; i >= 0; --i) {\n            if (upper >> i & 1) res += mat[i].rank0(r)\
      \ - mat[i].rank0(l);\n            l = (upper >> i & 1) ? mat[i].rank1(l) + mat[i].zeros\
      \ : mat[i].rank0(l);\n            r = (upper >> i & 1) ? mat[i].rank1(r) + mat[i].zeros\
      \ : mat[i].rank0(r);\n            if (l == r) break;\n        }\n        return\
      \ res;\n    }\n\n    int range_freq(int l, int r, T lower, T upper) {\n    \
      \    assert(0 <= l && l <= r && r <= n);\n        assert(0 <= lower && lower\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0035401949999993576
    environment: g++
    memory: 3.956
    name: all_zero_00
    status: AC
  - elapsed: 0.24055364800000234
    environment: g++
    memory: 4.068
    name: dense_large_a_00
    status: AC
  - elapsed: 0.060550480000003404
    environment: g++
    memory: 3.92
    name: dense_small_a_00
    status: AC
  - elapsed: 0.002537582000002203
    environment: g++
    memory: 3.76
    name: example_00
    status: AC
  - elapsed: 0.5201970930000002
    environment: g++
    memory: 7.704
    name: max_random_00
    status: AC
  - elapsed: 0.5215956250000033
    environment: g++
    memory: 7.736
    name: max_random_01
    status: AC
  - elapsed: 0.517448010999999
    environment: g++
    memory: 7.704
    name: max_random_02
    status: AC
  - elapsed: 0.5237217849999993
    environment: g++
    memory: 7.7
    name: max_random_03
    status: AC
  - elapsed: 0.5191968279999983
    environment: g++
    memory: 7.74
    name: max_random_04
    status: AC
  - elapsed: 0.3582171460000012
    environment: g++
    memory: 6.204
    name: random_00
    status: AC
  - elapsed: 0.38421021999999994
    environment: g++
    memory: 6.668
    name: random_01
    status: AC
  - elapsed: 0.2254998470000018
    environment: g++
    memory: 4.66
    name: random_02
    status: AC
  - elapsed: 0.19681658900000087
    environment: g++
    memory: 7.1
    name: random_03
    status: AC
  - elapsed: 0.1536324290000053
    environment: g++
    memory: 4.32
    name: random_04
    status: AC
  - elapsed: 0.0028230580000041527
    environment: g++
    memory: 3.76
    name: small_00
    status: AC
  - elapsed: 0.0023561279999952944
    environment: g++
    memory: 3.792
    name: small_01
    status: AC
  - elapsed: 0.002309500999999159
    environment: g++
    memory: 3.768
    name: small_02
    status: AC
  - elapsed: 0.0023176059999983067
    environment: g++
    memory: 3.664
    name: small_03
    status: AC
  - elapsed: 0.0028516389999992953
    environment: g++
    memory: 3.82
    name: small_04
    status: AC
  - elapsed: 0.0025747769999995285
    environment: g++
    memory: 3.788
    name: small_05
    status: AC
  - elapsed: 0.0026818730000002233
    environment: g++
    memory: 3.8
    name: small_06
    status: AC
  - elapsed: 0.00244695699999653
    environment: g++
    memory: 3.808
    name: small_07
    status: AC
  - elapsed: 0.0025252080000015553
    environment: g++
    memory: 3.76
    name: small_08
    status: AC
  - elapsed: 0.002551355000001365
    environment: g++
    memory: 3.808
    name: small_09
    status: AC
