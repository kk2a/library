...
data:
  ...
  embedded:
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/range_parallel_unionfind\n\
      ...
      \ << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_ds/ds_range_parallel_unionfind.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/range_parallel_unionfind\n\n#line\
      \ 1 \"unionfind/parallel.hpp\"\n\n\n\n#include <numeric>\n\n#line 1 \"string/dynamic_rolling_hash.hpp\"\
      ...
      \ n) : d(n, -1), nxt(n), roots(n) {\n        for (int i = 0; i < n; ++i) {\n\
      \            nxt[i] = i;\n            roots.init_set(i, i ^ (1 << 30));\n  \
      \      }\n        roots.build();\n    }\n\n    bool unite(int a, int b, int\
      ...
      \    std::swap(nxt[ll], nxt[rr]);\n            c = DR::lcp(roots, a, a + k,\
      \ roots, b, b + k);\n        }\n        return true;\n    }\n\n    int count\
      \ = 0;\n    double time = 0;\n\n    template <class F> bool unite(int a, int\
      \ b, int k, const F &f) {\n        int c = DR::lcp(roots, a, a + k, roots, b,\
      \ b + k);\n        if (c == k) return false;\n        while (c != k) {\n   \
      \         int ll = a + c, rr = b + c;\n            ll = roots.get(ll)[0].val()\
      \ ^ (1 << 30);\n            rr = roots.get(rr)[0].val() ^ (1 << 30);\n     \
  ...
  requiredBy: []
  testcases:
  - elapsed: 14.834343395000005
    environment: g++
    memory: 25.804
    name: decr_period_00
    status: AC
  - elapsed: 15.213935081000002
    environment: g++
    memory: 25.732
    name: decr_period_01
    status: AC
  - elapsed: 15.810253031000002
    environment: g++
    memory: 25.796
    name: decr_period_02
    status: AC
  - elapsed: 15.241926808999992
    environment: g++
    memory: 25.796
    name: decr_period_03
    status: AC
  - elapsed: 0.0026416690000132803
    environment: g++
    memory: 3.792
    name: example_00
    status: AC
  - elapsed: 0.0022164739999936955
    environment: g++
    memory: 3.756
    name: example_01
    status: AC
  - elapsed: 17.252796216000007
    environment: g++
    memory: 25.712
    name: large_k_00
    status: AC
  - elapsed: 16.011070491999988
    environment: g++
    memory: 25.732
    name: large_k_01
    status: AC
  - elapsed: 16.697912799999983
    environment: g++
    memory: 25.736
    name: large_k_02
    status: AC
  - elapsed: 14.463278728999995
    environment: g++
    memory: 25.804
    name: periodic_00
    status: AC
  - elapsed: 14.348889872
    environment: g++
    memory: 25.804
    name: periodic_01
    status: AC
  - elapsed: 14.443305554999995
    environment: g++
    memory: 25.772
    name: periodic_02
    status: AC
  - elapsed: 13.561431336999988
    environment: g++
    memory: 25.804
    name: periodic_03
    status: AC
  - elapsed: 12.80784994299998
    environment: g++
    memory: 23.672
    name: random_00
    status: AC
  - elapsed: 12.341174582000008
    environment: g++
    memory: 25.06
    name: random_01
    status: AC
  - elapsed: 1.8925627820000273
    environment: g++
    memory: 6.276
    name: random_02
    status: AC
  - elapsed: 0.18562515000002122
    environment: g++
    memory: 4.048
    name: small_00
    status: AC
  - elapsed: 0.2225965990000418
    environment: g++
    memory: 4.012
    name: small_01
    status: AC
  - elapsed: 0.23950964099998373
    environment: g++
    memory: 3.972
    name: small_02
    status: AC
  - elapsed: 0.2407791060000477
    environment: g++
    memory: 4.048
    name: small_03
    status: AC
  - elapsed: 0.2537428150000096
    environment: g++
    memory: 4.048
    name: small_04
    status: AC
  - elapsed: 0.2603534919999788
    environment: g++
    memory: 4.048
    name: small_05
    status: AC
  - elapsed: 0.2725369449999562
    environment: g++
    memory: 4.012
    name: small_06
    status: AC
  - elapsed: 0.26765686300001335
    environment: g++
    memory: 4.012
    name: small_07
    status: AC
  - elapsed: 0.27449407400001746
    environment: g++
    memory: 4.012
    name: small_08
    status: AC
  - elapsed: 0.2787928939999915
    environment: g++
    memory: 4.008
    name: small_09
    status: AC
  - elapsed: 3.298208334000037
    environment: g++
    memory: 25.732
    name: small_k_00
    status: AC
  - elapsed: 3.3166695889999573
    environment: g++
    memory: 25.808
    name: small_k_01
    status: AC
  - elapsed: 3.2364075149999962
    environment: g++
    memory: 25.8
    name: small_k_02
    status: AC
