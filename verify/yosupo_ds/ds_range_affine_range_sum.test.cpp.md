...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/range_affine_range_sum\n\
      ...
      \ r).a << \"\\n\";\n        }\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_ds/ds_range_affine_range_sum.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/range_affine_range_sum\n\n#line 1\
      \ \"modint/mont.hpp\"\n\n\n\n#include <cassert>\n#include <cstdint>\n#include\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0026233250000018415
    environment: g++
    memory: 3.632
    name: example_00
    status: AC
  - elapsed: 4.476168800000011
    environment: g++
    memory: 19.82
    name: max_random_00
    status: AC
  - elapsed: 4.481542136000002
    environment: g++
    memory: 19.764
    name: max_random_01
    status: AC
  - elapsed: 4.484164665999998
    environment: g++
    memory: 19.648
    name: max_random_02
    status: AC
  - elapsed: 3.6264627999999846
    environment: g++
    memory: 18.992
    name: random_00
    status: AC
  - elapsed: 3.6906435980000083
    environment: g++
    memory: 19.492
    name: random_01
    status: AC
  - elapsed: 2.5937175770000067
    environment: g++
    memory: 5.532
    name: random_02
    status: AC
  - elapsed: 0.0027546009999923626
    environment: g++
    memory: 3.776
    name: small_00
    status: AC
  - elapsed: 0.0025625450000177352
    environment: g++
    memory: 3.78
    name: small_01
    status: AC
  - elapsed: 0.0028964869999867915
    environment: g++
    memory: 3.792
    name: small_02
    status: AC
  - elapsed: 0.002808681999994178
    environment: g++
    memory: 3.628
    name: small_03
    status: AC
  - elapsed: 0.003199410000007674
    environment: g++
    memory: 3.776
    name: small_04
    status: AC
  - elapsed: 0.0032239810000191937
    environment: g++
    memory: 3.632
    name: small_05
    status: AC
  - elapsed: 0.0032493519999832188
    environment: g++
    memory: 3.78
    name: small_06
    status: AC
  - elapsed: 0.003141104999997424
    environment: g++
    memory: 3.776
    name: small_07
    status: AC
  - elapsed: 0.003526402999995071
    environment: g++
    memory: 3.772
    name: small_08
    status: AC
  - elapsed: 0.0035309259999962705
    environment: g++
    memory: 3.78
    name: small_09
    status: AC
  - elapsed: 0.0075779119999879185
    environment: g++
    memory: 3.78
    name: small_random_00
    status: AC
  - elapsed: 0.0061968400000012025
    environment: g++
    memory: 3.768
