...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_ds/ds_ordered_set_max_right.test.cpp\"\n#define\
    ...
    \ rbtree {\n\ntemplate <class M> struct RedBlackTree : RedBlackTreeBase<RedBlackTree<M>,\
    ...
    \ x;\n        kin >> t >> x;\n        if (t == 0) {\n            auto [k, a, b]\
    \ = rb.max_right(root, 0, [&](auto t) { return t.is_unit or t.a < x; });\n   \
