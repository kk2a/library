...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_ds/ds_point_set_range_composite.test.cpp\"\
    ...
    \n#include <functional>\n#include <vector>\n\nnamespace kk2 {\n\ntemplate <class\
    \ S, S (*op)(S, S), S (*e)()> struct SegmentTree {\n  public:\n    SegmentTree()\
    \ : SegmentTree(0) {}\n\n    SegmentTree(int n) : _n(n) {\n        log = 0;\n\
    \        while ((1U << log) < (unsigned int)(_n)) log++;\n        size = 1 <<\
    \ log;\n        d = std::vector<S>(2 * size, e());\n    }\n\n    template <class...\
    \ Args> SegmentTree(int n, Args... args)\n        : SegmentTree(std::vector<S>(n,\
    ...
    \ { return (a > b ? a = b, 1 : 0); }\n\n\n#line 8 \"verify/yosupo_ds/ds_point_set_range_composite.test.cpp\"\
    \nusing namespace std;\n\nint main() {\n    int n, q;\n    kin >> n >> q;\n  \
