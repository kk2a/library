...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/segment_add_get_min\n\
      ...
      \ kout << \"INFINITY\\n\";\n        }\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_ds/ds_segment_add_get_min.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/segment_add_get_min\n\n#line 1 \"\
      segment_tree/li_chao_tree.hpp\"\n\n\n\n#include <algorithm>\n#include <cassert>\n\
      ...
      \u304C\u3067\u304D\u306A\u3044\u3068\u3044\u3051\u306A\u3044\uFF0E\n * @tparam\
      \ IsMin \u30AF\u30A8\u30EA\u304Cmin\u304Bmax\u304B\n */\ntemplate <class X,\
      \ class T, bool isMin = true> struct LiChaoTree {\n    struct Line {\n     \
      \   T a, b; // y = ax + b\n        bool is_unit;\n        Line() : a(0), b(0),\
      \ is_unit(true) {}\n        Line(T a_, T b_) : a(isMin ? a_ : -a_), b(isMin\
      \ ? b_ : -b_), is_unit(false) {}\n        auto eval(X x) const { return a *\
      ...
      \ xs.end()), xs.end());\n        n = xs.size();\n        if (n == 0) return;\n\
      \        lg = 0;\n        while ((1 << lg) < n) ++lg;\n        siz = 1 << lg;\n\
      \        xs.resize(siz);\n        std::iota(xs.begin() + n, xs.end(), xs[n -\
      \ 1] + 1);\n        d.resize(siz * 2, Line());\n    }\n\n    void add_line(T\
      \ a, T b) { inner_add(1, lg, Line(a, b)); }\n\n    void add_seg(X l, X r, T\
      ...
      \ & 1) --rr, inner_add(rr, i, line);\n        }\n    }\n\n    std::optional<value_type>\
      \ get(X x) const {\n        int pos = std::lower_bound(xs.begin(), xs.end(),\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/yosupo_ds/ds_segment_add_get_min.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    int n, q;\n    kin >> n >> q;\n\
      \    vc<array<i64, 4>> segs(n);\n    kin >> segs;\n    vc<array<i64, 5>> queries(q);\n\
      \    vc<int> xs;\n    rep(i, q) {\n        kin >> queries[i][0];\n        if\
      \ (queries[i][0] == 0) {\n            kin >> queries[i][1] >> queries[i][2]\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.18104196000001593
    environment: g++
    memory: 17.612
    name: all_intersect_00
    status: AC
  - elapsed: 0.8177300150000519
    environment: g++
    memory: 31.896
    name: all_twice_00
    status: AC
  - elapsed: 0.0026059819999773026
    environment: g++
    memory: 3.832
    name: example_00
    status: AC
  - elapsed: 0.002206739000030211
    environment: g++
    memory: 3.776
    name: example_01
    status: AC
  - elapsed: 0.8995322920000035
    environment: g++
    memory: 24.888
    name: max_random_00
    status: AC
  - elapsed: 0.8771526130000211
    environment: g++
    memory: 24.824
    name: max_random_01
    status: AC
  - elapsed: 0.8789613449999933
    environment: g++
    memory: 24.896
    name: max_random_02
    status: AC
  - elapsed: 0.22735593300001256
    environment: g++
    memory: 17.608
    name: no_output_00
    status: AC
  - elapsed: 0.5898324359999378
    environment: g++
    memory: 20.532
    name: random_00
    status: AC
  - elapsed: 0.6578400260000308
    environment: g++
    memory: 21.028
    name: random_01
    status: AC
  - elapsed: 0.3550065370000084
    environment: g++
    memory: 13.756
    name: random_02
    status: AC
  - elapsed: 0.0025445339999805583
    environment: g++
    memory: 3.596
    name: small_00
    status: AC
  - elapsed: 0.002231131000030473
    environment: g++
    memory: 3.664
    name: small_01
    status: AC
