...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/set_xor_min\n\
      ...
      n\";\n            bt.operate_xor(x);\n        }\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_ds/ds_set_xor_min.test.cpp\"\n// competitive-verifier:\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.5651184800000237
    environment: g++
    memory: 76.928
    name: almost_all_insert_00
    status: AC
  - elapsed: 0.39148350900001105
    environment: g++
    memory: 4.016
    name: almost_all_query_00
    status: AC
  - elapsed: 0.2649824030000332
    environment: g++
    memory: 3.976
    name: almost_all_query_close_00
    status: AC
  - elapsed: 0.002618050000023686
    environment: g++
    memory: 3.624
    name: ans_big_00
    status: AC
  - elapsed: 0.002190410000025622
    environment: g++
    memory: 3.72
    name: example_00
    status: AC
  - elapsed: 0.48646729300003244
    environment: g++
    memory: 44.284
    name: max_ans_small_00
    status: AC
  - elapsed: 0.43235761999994793
    environment: g++
    memory: 29.948
    name: max_random_00
    status: AC
  - elapsed: 0.43845153400002346
    environment: g++
    memory: 29.948
    name: max_random_01
    status: AC
  - elapsed: 0.43066202599999315
    environment: g++
    memory: 29.944
    name: max_random_02
    status: AC
  - elapsed: 0.32974281500003144
    environment: g++
    memory: 23.976
    name: random_00
    status: AC
  - elapsed: 0.4150040929999932
    environment: g++
    memory: 27.184
    name: random_01
    status: AC
  - elapsed: 0.04421900699998105
    environment: g++
    memory: 8.04
    name: random_02
    status: AC
