...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/sqrt_mod\n\
      ...
      \ p) << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_math/sqrt_mod.test.cpp\"\n// competitive-verifier:\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002709744000000569
    environment: g++
    memory: 3.736
    name: example_00
    status: AC
  - elapsed: 0.1114708209999975
    environment: g++
    memory: 3.96
    name: max_random_00
    status: AC
  - elapsed: 0.11118185199999431
    environment: g++
    memory: 3.968
    name: max_random_01
    status: AC
  - elapsed: 0.11168182499999801
    environment: g++
    memory: 3.968
    name: max_random_02
    status: AC
  - elapsed: 0.11288005400000145
    environment: g++
    memory: 4.012
    name: max_random_03
    status: AC
  - elapsed: 0.11491732600000404
    environment: g++
    memory: 3.892
    name: max_random_04
    status: AC
  - elapsed: 0.22674797900000243
    environment: g++
    memory: 3.98
    name: mod_998244353_00
    status: AC
  - elapsed: 0.22555051700000206
    environment: g++
    memory: 3.98
    name: mod_998244353_01
    status: AC
  - elapsed: 0.021871351999998012
    environment: g++
    memory: 3.98
    name: random_00
    status: AC
  - elapsed: 0.024165781000000663
    environment: g++
    memory: 3.956
    name: random_01
    status: AC
  - elapsed: 0.07052476800000562
    environment: g++
    memory: 3.984
    name: random_02
    status: AC
  - elapsed: 0.0311128889999992
    environment: g++
    memory: 3.988
    name: random_03
    status: AC
  - elapsed: 0.11197205300000235
    environment: g++
    memory: 4.008
    name: random_04
    status: AC
