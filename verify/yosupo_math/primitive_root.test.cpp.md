...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_math/primitive_root.test.cpp\"\n#define PROBLEM\
...
layout: document
redirect_from:
- /verify/verify/yosupo_math/primitive_root.test.cpp
- /verify/verify/yosupo_math/primitive_root.test.cpp.html
