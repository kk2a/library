...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/enumerate_quotients\n\
      ...
      n\";\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_math/enumerate_quotients.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/enumerate_quotients\n\n#line 1 \"\
      math/enumerate_quotients.hpp\"\n\n\n\n#include <numeric>\n#include <vector>\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/yosupo_math/enumerate_quotients.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    i64 n;\n    kin >> n;\n    kk2::EnumerateQuotients<i64>\
      \ res(n);\n    kout << res.size() << \"\\n\";\n    kout << res.get() << \"\\\
      n\";\n\n    return 0;\n}\n"
    name: bundled
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0023647200000027624
    environment: g++
    memory: 3.808
    name: example_00
    status: AC
  - elapsed: 0.11149147099999368
    environment: g++
    memory: 19.24
    name: max_00
    status: AC
  - elapsed: 0.0023245239999880596
    environment: g++
    memory: 3.724
    name: min_00
    status: AC
  - elapsed: 0.0018028900000217618
    environment: g++
    memory: 3.828
    name: min_01
    status: AC
  - elapsed: 0.001765760000012051
    environment: g++
    memory: 3.816
    name: min_02
    status: AC
  - elapsed: 0.001787917000001471
    environment: g++
    memory: 3.828
    name: min_03
    status: AC
  - elapsed: 0.0017879370000173367
    environment: g++
    memory: 3.72
    name: min_04
    status: AC
  - elapsed: 0.0018636009999966063
    environment: g++
    memory: 3.732
    name: min_05
    status: AC
  - elapsed: 0.0017927550000251813
    environment: g++
    memory: 3.688
    name: min_06
    status: AC
  - elapsed: 0.0017717780000054972
    environment: g++
    memory: 3.708
    name: min_07
    status: AC
  - elapsed: 0.0017634160000170596
    environment: g++
    memory: 3.848
    name: min_08
    status: AC
  - elapsed: 0.10941746400001762
    environment: g++
    memory: 19.264
    name: polynom_p1p1m1_00
    status: AC
  - elapsed: 0.05062110500000472
    environment: g++
    memory: 10.848
    name: polynom_p1p1m1_01
    status: AC
  - elapsed: 0.11100515100000052
    environment: g++
    memory: 19.236
    name: polynom_p1p1z_00
    status: AC
  - elapsed: 0.0508276460000161
    environment: g++
    memory: 10.788
    name: polynom_p1p1z_01
    status: AC
  - elapsed: 0.11110625099999538
    environment: g++
    memory: 19.272
    name: polynom_p1zm1_00
    status: AC
  - elapsed: 0.050743398999998135
    environment: g++
    memory: 10.88
    name: polynom_p1zm1_01
    status: AC
  - elapsed: 0.05292417699999419
    environment: g++
    memory: 11.216
    name: random_00
    status: AC
  - elapsed: 0.07761633499998766
    environment: g++
    memory: 14.308
    name: random_01
    status: AC
  - elapsed: 0.0023438480000095296
    environment: g++
    memory: 3.86
    name: random_small_00
    status: AC
  - elapsed: 0.0018687230000011823
    environment: g++
    memory: 3.836
    name: random_small_01
    status: AC
  - elapsed: 0.0018522189999998773
    environment: g++
    memory: 3.848
    name: random_small_02
    status: AC
  - elapsed: 0.0018101550000153566
    environment: g++
    memory: 3.876
    name: random_small_03
    status: AC
  - elapsed: 0.0018472120000012637
    environment: g++
    memory: 3.828
    name: random_small_04
    status: AC
  - elapsed: 0.043348629999997
    environment: g++
    memory: 9.7
    name: square_00
    status: AC
  - elapsed: 0.05140837300001522
    environment: g++
    memory: 10.84
    name: square_01
    status: AC
