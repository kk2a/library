...
data:
  ...
  - type_traits/io.hpp
  embedded:
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/primality_test\n\
      \n#include \"../../math/is_prime.hpp\"\n#include \"../../template/template.hpp\"\
      \nusing namespace std;\n\nint main() {\n    int q;\n    kin >> q;\n    rep (q)\
      \ {\n        u64 n;\n        kin >> n;\n        Yes(kk2::is_prime(n));\n   \
      \ }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_math/primality_test.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/primality_test\n\n#line 1 \"math/is_prime.hpp\"\
      \n\n\n\n#include <vector>\n\n#line 1 \"math_mod/pow_mod.hpp\"\n\n\n\n#include\
      \ <cassert>\n\nnamespace kk2 {\n\ntemplate <class S, class T, class U> constexpr\
      \ S pow_mod(T x, U n, T m) {\n    assert(n >= 0);\n    if (m == 1) return S(0);\n\
      \    S _m = m, r = 1;\n    S y = x % _m;\n    if (y < 0) y += _m;\n    while\
      \ (n) {\n        if (n & 1) r = (r * y) % _m;\n        if (n >>= 1) y = (y *\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.5066854960000455
    environment: g++
    memory: 3.816
    name: all_prime_00
    status: AC
  - elapsed: 0.0032801570000060565
    environment: g++
    memory: 3.772
    name: carmichael_00
    status: AC
  - elapsed: 0.0022687339999833966
    environment: g++
    memory: 3.772
    name: example_00
    status: AC
  - elapsed: 0.0022845830000051137
    environment: g++
    memory: 3.792
    name: hack_issue1325_00
    status: AC
  - elapsed: 0.002326645000039207
    environment: g++
    memory: 3.764
    name: hack_issue996_00
    status: AC
  - elapsed: 0.04848112399997717
    environment: g++
    memory: 4.016
    name: less_1000000000_00
    status: AC
  - elapsed: 0.1276991409999937
    environment: g++
    memory: 4.02
    name: prod_two_prime_00
    status: AC
  - elapsed: 0.0026509049999958734
    environment: g++
    memory: 3.624
    name: pseudoprimes_00
    status: AC
  - elapsed: 0.0853113379999968
    environment: g++
    memory: 3.832
    name: random_00
    status: AC
  - elapsed: 0.08562652500000922
    environment: g++
    memory: 3.992
    name: random_01
    status: AC
  - elapsed: 0.08552754900000537
    environment: g++
    memory: 4.016
    name: random_02
    status: AC
  - elapsed: 0.03716476899995769
    environment: g++
    memory: 3.976
    name: small_00
    status: AC
