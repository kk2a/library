...
data:
  ...
  - type_traits/io.hpp
  embedded:
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/many_factorials\n\
      ...
      \  }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_math/many_factrials.test.cpp\"\n// competitive-verifier:\
      ...
      \ mint _large_fact(int n) {\n        _build();\n        mint res;\n        int\
      \ q = n / BLOCK_SIZE, r = n % BLOCK_SIZE;\n        if (2 * r <= BLOCK_SIZE)\
      \ {\n            res = _block_fact[q];\n            for (int i = 0; i < r; i++)\
      \ { res *= n - i; }\n        } else if (q != BLOCK_NUM) {\n            res =\
      \ _block_fact[q + 1];\n            mint den = 1;\n            for (int i = 1;\
      \ i <= BLOCK_SIZE - r; i++) { den *= n + i; }\n            res /= den;\n   \
      \     } else {\n            res = -1;\n            mint den = 1;\n         \
  ...
  requiredBy: []
  testcases:
  - elapsed: 3.5615325859998848
    environment: g++
    memory: 51.528
    name: example_00
    status: AC
  - elapsed: 3.7088631490000807
    environment: g++
    memory: 46.112
    name: many_bits_00
    status: AC
  - elapsed: 3.769444549000127
    environment: g++
    memory: 54.592
    name: many_bits_01
    status: AC
  - elapsed: 3.788697867999872
    environment: g++
    memory: 52.952
    name: many_bits_02
    status: AC
  - elapsed: 3.773878572000058
    environment: g++
    memory: 54.48
    name: many_bits_03
    status: AC
  - elapsed: 3.7716614389998995
    environment: g++
    memory: 56.328
    name: many_bits_04
    status: AC
  - elapsed: 3.6290818920001584
    environment: g++
    memory: 37.04
    name: near_half_00
    status: AC
  - elapsed: 3.629801359000112
    environment: g++
    memory: 37.004
    name: near_half_01
    status: AC
  - elapsed: 3.653152746999922
    environment: g++
    memory: 36.976
    name: near_max_00
    status: AC
  - elapsed: 3.625451969000096
    environment: g++
    memory: 37.032
    name: near_max_01
    status: AC
  - elapsed: 3.8014219570000023
    environment: g++
    memory: 46.972
    name: random_00
    status: AC
  - elapsed: 3.856659708000052
    environment: g++
    memory: 54.772
    name: random_01
    status: AC
