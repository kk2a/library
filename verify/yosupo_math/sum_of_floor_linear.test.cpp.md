...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/sum_of_floor_of_linear\n\
    ...
    name: default
  - code: "#line 1 \"verify/yosupo_math/sum_of_floor_linear.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/sum_of_floor_of_linear\n\n#line 1\
      \ \"math/floor_sum.hpp\"\n\n\n\n#include <algorithm>\n\nnamespace kk2 {\n\n\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0027872670000022026
    environment: g++
    memory: 3.736
    name: example_00
    status: AC
  - elapsed: 0.02059393799999043
    environment: g++
    memory: 3.912
    name: random_00
    status: AC
  - elapsed: 0.07458394500000054
    environment: g++
    memory: 3.892
    name: random_01
    status: AC
  - elapsed: 0.05777695400000482
    environment: g++
    memory: 3.984
    name: random_02
    status: AC
  - elapsed: 0.03964952399999788
    environment: g++
    memory: 3.984
    name: random_03
    status: AC
  - elapsed: 0.017998399999996195
    environment: g++
    memory: 3.948
    name: random_04
    status: AC
  - elapsed: 0.010750350000009234
    environment: g++
    memory: 3.98
    name: small_00
    status: AC
  - elapsed: 0.03494882199998983
    environment: g++
    memory: 3.992
    name: small_01
    status: AC
  - elapsed: 0.027642223000000854
    environment: g++
    memory: 3.988
    name: small_02
    status: AC
  - elapsed: 0.01947378900000274
    environment: g++
    memory: 3.996
    name: small_03
    status: AC
  - elapsed: 0.009399874999999724
    environment: g++
    memory: 4.02
    name: small_04
    status: AC
