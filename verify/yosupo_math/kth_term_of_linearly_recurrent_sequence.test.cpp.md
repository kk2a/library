...
data:
  ...
  - code: "#define IGNORE\n// #define PROBLEM \"https://judge.yosupo.jp/problem/kth_term_of_linearly_recurrent_sequence\"\
      ...
      \ {\n    int d;\n    i64 k;\n    kin >> d >> k;\n    FPS a(d), c(d);\n    kin\
      \ >> a >> c;\n    kout << kk2::kth_term_of_linearly_recurrent_sequence(a, c,\
      \ k) << kendl;\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_math/kth_term_of_linearly_recurrent_sequence.test.cpp\"\
      \n#define IGNORE\n// #define PROBLEM \"https://judge.yosupo.jp/problem/kth_term_of_linearly_recurrent_sequence\"\
      \n// \u843D\u3061\u308B\u3053\u3068\u304C\u3042\u308B\u306E\u3067\u4FEE\u6B63\
      \u3059\u308B\n\n#line 1 \"fps/bostan_mori.hpp\"\n\n\n\n#include <cassert>\n\n\
      namespace kk2 {\n\n// return [x^n] (p(x) / q(x))\ntemplate <class FPS, class\
      \ mint = typename FPS::value_type>\nmint bostan_mori(const FPS &p, const FPS\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 9 \"verify/yosupo_math/kth_term_of_linearly_recurrent_sequence.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\nint main()\
      \ {\n    int d;\n    i64 k;\n    kin >> d >> k;\n    FPS a(d), c(d);\n    kin\
      \ >> a >> c;\n    kout << kk2::kth_term_of_linearly_recurrent_sequence(a, c,\
      \ k) << kendl;\n\n    return 0;\n}\n"
