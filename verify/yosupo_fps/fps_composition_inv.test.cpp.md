...
data:
  ...
  - code: "// competitive-verifier: PROBLEM\n// https://judge.yosupo.jp/problem/compositional_inverse_of_formal_power_series_large\n\
      ...
      \n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_fps/fps_composition_inv.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM\n// https://judge.yosupo.jp/problem/compositional_inverse_of_formal_power_series_large\n\
      \n#line 1 \"fps/compositional_inv.hpp\"\n\n\n\n#include <cassert>\n\n#line 1\
      \ \"fps/power_projection.hpp\"\n\n\n\n#include <algorithm>\n#include <functional>\n\
      #include <vector>\n\nnamespace kk2 {\n\n// n = \\deg f\n// [X ^ n] f(X) ^ i\
      \ g(X)  enumerate for i = 0, ... , m\ntemplate <class FPS, class mint = typename\
      \ FPS::value_type>\nFPS power_projection(const FPS &f, const FPS &g = {1}, int\
      ...
      \      };\n\n        np.clear(), nq.clear();\n        for (int i = 0; i <= n;\
      \ i++) {\n            buf.resize(k);\n            std::copy(std::begin(p) +\
      \ i * k, std::begin(p) + (i + 1) * k, std::begin(buf));\n            db();\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 8 \"verify/yosupo_fps/fps_composition_inv.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\nint main()\
      \ {\n    int n;\n    kin >> n;\n    FPS f(n);\n    f.input(kin);\n    kk2::compositional_inv(f).output(kout);\n\
      \n    return 0;\n}\n"
    name: bundled
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002768873999968946
    environment: g++
    memory: 3.82
    name: example_00
    status: AC
  - elapsed: 0.0021526140000105443
    environment: g++
    memory: 3.636
    name: identity_00
    status: AC
  - elapsed: 7.382443526000031
    environment: g++
    memory: 16.344
    name: max_identity_00
    status: AC
  - elapsed: 9.544451131000017
    environment: g++
    memory: 16.408
    name: max_random_00
    status: AC
  - elapsed: 9.547374909999974
    environment: g++
    memory: 16.396
    name: max_random_01
    status: AC
  - elapsed: 9.533092398000008
    environment: g++
    memory: 16.336
    name: max_random_02
    status: AC
  - elapsed: 9.534470867000039
    environment: g++
    memory: 16.408
    name: max_random_03
    status: AC
  - elapsed: 9.535878167999954
    environment: g++
    memory: 16.408
    name: max_random_04
    status: AC
  - elapsed: 0.3638470859999643
    environment: g++
    memory: 4.3
    name: mid_00
    status: AC
  - elapsed: 0.36390242599998146
    environment: g++
    memory: 4.176
    name: mid_01
    status: AC
  - elapsed: 0.3566638340000168
    environment: g++
    memory: 4.252
    name: mid_02
    status: AC
  - elapsed: 0.17217710500000294
    environment: g++
    memory: 4.156
    name: mid_03
    status: AC
  - elapsed: 0.38472831000001406
    environment: g++
    memory: 4.312
    name: mid_04
    status: AC
  - elapsed: 9.461684122000008
    environment: g++
    memory: 16.38
    name: random_00
    status: AC
  - elapsed: 8.561673190000022
    environment: g++
    memory: 15.348
    name: random_01
    status: AC
  - elapsed: 4.159560610999961
    environment: g++
    memory: 9.728
    name: random_02
    status: AC
  - elapsed: 3.9035365919999663
    environment: g++
    memory: 9.832
    name: random_03
    status: AC
  - elapsed: 0.8688474930000325
    environment: g++
    memory: 5.196
    name: random_04
    status: AC
  - elapsed: 0.0024048419999758153
    environment: g++
    memory: 3.828
    name: small_degree_00
    status: AC
  - elapsed: 0.0022952719999693727
    environment: g++
    memory: 3.828
    name: small_degree_01
    status: AC
  - elapsed: 0.0022500409999679505
    environment: g++
    memory: 3.848
    name: small_degree_02
    status: AC
  - elapsed: 0.002245340000001761
    environment: g++
    memory: 3.836
    name: small_degree_03
    status: AC
  - elapsed: 0.00224140500000658
    environment: g++
    memory: 3.82
    name: small_degree_04
    status: AC
  - elapsed: 0.002273462000005111
    environment: g++
    memory: 3.812
    name: small_degree_05
    status: AC
  - elapsed: 0.002334389999987252
    environment: g++
    memory: 3.816
    name: small_degree_06
    status: AC
  - elapsed: 0.002450733999978638
    environment: g++
    memory: 3.748
    name: small_degree_07
    status: AC
  - elapsed: 0.002366479999977855
    environment: g++
    memory: 3.632
    name: small_degree_08
    status: AC
  - elapsed: 0.002385118000006514
    environment: g++
    memory: 3.816
