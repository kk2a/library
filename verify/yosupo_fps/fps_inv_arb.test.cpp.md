...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/inv_of_formal_power_series\n\
      ...
      \n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_fps/fps_inv_arb.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/inv_of_formal_power_series\n\n#line\
      \ 1 \"fps/fps_arb.hpp\"\n\n\n\n#include <algorithm>\n#include <cassert>\n#include\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 6 \"verify/yosupo_fps/fps_inv_arb.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSArb<kk2::mont998>;\n\nint main()\
      \ {\n    int n;\n    kin >> n;\n    FPS f(n);\n    f.input(kin).inv().output(kout);\n\
      \n    return 0;\n}\n"
    name: bundled
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0031053909999911866
    environment: g++
    memory: 3.888
    name: example_00
    status: AC
  - elapsed: 14.888712585999997
    environment: g++
    memory: 52.42
    name: max_random_00
    status: AC
  - elapsed: 14.884226308000024
    environment: g++
    memory: 52.484
    name: max_random_01
    status: AC
  - elapsed: 14.861016669000037
    environment: g++
    memory: 52.44
    name: max_random_02
    status: AC
  - elapsed: 14.939530037999987
    environment: g++
    memory: 52.444
    name: max_random_03
    status: AC
  - elapsed: 14.890845974000001
    environment: g++
    memory: 52.456
    name: max_random_04
    status: AC
  - elapsed: 14.984827299000017
    environment: g++
    memory: 52.44
    name: max_random_or_zero_00
    status: AC
  - elapsed: 7.17298008299997
    environment: g++
    memory: 27.384
    name: near_262144_00
    status: AC
  - elapsed: 7.294043938999948
    environment: g++
    memory: 27.408
    name: near_262144_01
    status: AC
  - elapsed: 14.866706591000025
    environment: g++
    memory: 50.956
    name: near_262144_02
    status: AC
  - elapsed: 14.803203875000008
    environment: g++
    memory: 45.732
    name: random_00
    status: AC
  - elapsed: 14.874326435
    environment: g++
    memory: 52.0
    name: random_01
    status: AC
  - elapsed: 1.6648579580000273
    environment: g++
    memory: 8.96
    name: random_02
    status: AC
  - elapsed: 14.881140640000012
    environment: g++
    memory: 45.528
    name: random_03
    status: AC
  - elapsed: 14.787966637000011
    environment: g++
    memory: 50.96
    name: random_04
    status: AC
  - elapsed: 0.0030211360000294007
    environment: g++
    memory: 3.78
    name: small_degree_00
    status: AC
  - elapsed: 0.0026247690000218427
    environment: g++
    memory: 3.88
    name: small_degree_01
    status: AC
  - elapsed: 0.002520441999990908
    environment: g++
    memory: 3.864
    name: small_degree_02
    status: AC
  - elapsed: 0.002492339000013999
    environment: g++
    memory: 3.86
    name: small_degree_03
    status: AC
  - elapsed: 0.0024262449999810087
    environment: g++
    memory: 3.88
    name: small_degree_04
    status: AC
  - elapsed: 0.002528173999962746
    environment: g++
    memory: 3.732
    name: small_degree_05
    status: AC
  - elapsed: 0.0024841160000050877
    environment: g++
    memory: 3.88
    name: small_degree_06
    status: AC
  - elapsed: 0.0024937359999626096
    environment: g++
    memory: 3.9
    name: small_degree_07
    status: AC
  - elapsed: 0.002538920999995753
    environment: g++
    memory: 3.896
    name: small_degree_08
    status: AC
  - elapsed: 0.0025154740000061793
    environment: g++
    memory: 3.732
