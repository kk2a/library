...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/inv_of_polynomials\n\
      ...
      \ kout << -1 << kendl;\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_fps/poly_inv.test.cpp\"\n// competitive-verifier:\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.09928981199999498
    environment: g++
    memory: 4.076
    name: abnormal_random_00
    status: AC
  - elapsed: 0.10056282099999692
    environment: g++
    memory: 3.884
    name: abnormal_random_01
    status: AC
  - elapsed: 0.10112091899999598
    environment: g++
    memory: 4.084
    name: abnormal_random_02
    status: AC
  - elapsed: 0.1306353929999915
    environment: g++
    memory: 3.936
    name: abnormal_random_03
    status: AC
  - elapsed: 0.10294004300000381
    environment: g++
    memory: 4.048
    name: abnormal_random_04
    status: AC
  - elapsed: 0.0023906879999913144
    environment: g++
    memory: 3.82
    name: example_00
    status: AC
  - elapsed: 0.0023189120000068897
    environment: g++
    memory: 3.804
    name: example_01
    status: AC
  - elapsed: 0.002288405000001603
    environment: g++
    memory: 3.828
    name: example_02
    status: AC
  - elapsed: 17.455838662000005
    environment: g++
    memory: 10.116
    name: max_random_00
    status: AC
  - elapsed: 17.444899203999995
    environment: g++
    memory: 10.16
    name: max_random_01
    status: AC
  - elapsed: 17.433732794000008
    environment: g++
    memory: 10.028
    name: max_random_02
    status: AC
  - elapsed: 17.454572976999998
    environment: g++
    memory: 10.152
    name: max_random_03
    status: AC
  - elapsed: 17.430982002999997
    environment: g++
    memory: 10.176
    name: max_random_04
    status: AC
  - elapsed: 4.087948293999972
    environment: g++
    memory: 5.948
    name: random_00
    status: AC
  - elapsed: 2.0957839360000037
    environment: g++
    memory: 5.156
    name: random_01
    status: AC
  - elapsed: 3.646825045999975
    environment: g++
    memory: 6.092
    name: random_02
    status: AC
  - elapsed: 10.059455457999974
    environment: g++
    memory: 8.2
    name: random_03
    status: AC
  - elapsed: 6.009549367999995
    environment: g++
    memory: 6.332
    name: random_04
    status: AC
