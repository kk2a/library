...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/sqrt_of_formal_power_series_sparse\n\
    ...
    name: default
  - code: "#line 1 \"verify/yosupo_fps/fps_sprase_sqrt.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/sqrt_of_formal_power_series_sparse\n\
      ...
      \ T> ArbitraryLazyMontgomeryModIntBase(const T &b)\n        : _v(reduce(ULong(b\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 7 \"verify/yosupo_fps/fps_sprase_sqrt.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\nint main()\
      \ {\n    int n, k;\n    kin >> n >> k;\n    FPS f(n);\n    rep (k) {\n     \
      \   int i;\n        kk2::mont998 a;\n        kin >> i >> a;\n        f[i] =\
      \ a;\n    }\n    FPS res = kk2::sparse_sqrt(f);\n    if (res.empty()) kout <<\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002895207999998206
    environment: g++
    memory: 3.612
    name: example_00
    status: AC
  - elapsed: 0.002311185000010596
    environment: g++
    memory: 3.816
    name: example_01
    status: AC
  - elapsed: 0.002247139999994374
    environment: g++
    memory: 3.8
    name: example_02
    status: AC
  - elapsed: 0.01304541599999709
    environment: g++
    memory: 7.352
    name: max_random_00
    status: AC
  - elapsed: 0.012658274999992614
    environment: g++
    memory: 7.312
    name: max_random_01
    status: AC
  - elapsed: 0.01327199099999632
    environment: g++
    memory: 7.292
    name: max_random_02
    status: AC
  - elapsed: 0.6836992469999927
    environment: g++
    memory: 27.688
    name: max_random_03
    status: AC
  - elapsed: 0.013620825999993258
    environment: g++
    memory: 7.352
    name: max_random_04
    status: AC
  - elapsed: 0.6135375040000071
    environment: g++
    memory: 27.976
    name: max_random_05
    status: AC
  - elapsed: 0.01281813999999315
    environment: g++
    memory: 7.348
    name: max_random_06
    status: AC
  - elapsed: 0.04649724600000127
    environment: g++
    memory: 14.992
    name: max_random_07
    status: AC
  - elapsed: 0.04626730500000065
    environment: g++
    memory: 14.836
    name: max_random_08
    status: AC
  - elapsed: 0.012821555999991574
    environment: g++
    memory: 7.348
    name: max_random_09
    status: AC
  - elapsed: 0.028235820999995553
    environment: g++
    memory: 6.584
    name: min_K_00
    status: AC
  - elapsed: 0.03305319000000395
    environment: g++
    memory: 7.092
    name: min_K_01
    status: AC
  - elapsed: 0.021141568999993865
    environment: g++
    memory: 7.864
    name: random_00
    status: AC
  - elapsed: 0.0079081049999985
    environment: g++
    memory: 5.14
    name: random_01
    status: AC
  - elapsed: 0.008351081000000704
    environment: g++
    memory: 5.66
    name: random_02
    status: AC
  - elapsed: 0.020194529999997712
    environment: g++
    memory: 7.188
    name: random_03
    status: AC
  - elapsed: 0.016939359999994963
    environment: g++
    memory: 6.572
    name: random_04
    status: AC
  - elapsed: 0.15445901100000015
    environment: g++
    memory: 11.86
    name: random_05
    status: AC
  - elapsed: 0.007968245000000707
    environment: g++
    memory: 5.14
    name: random_06
    status: AC
  - elapsed: 0.21372085699999843
    environment: g++
    memory: 19.092
    name: random_07
    status: AC
  - elapsed: 0.397668895999999
    environment: g++
    memory: 23.32
    name: random_08
    status: AC
  - elapsed: 0.008962478000000829
    environment: g++
    memory: 5.876
    name: random_09
    status: AC
  - elapsed: 0.002562255000000846
    environment: g++
    memory: 3.804
    name: small_N_00
    status: AC
  - elapsed: 0.002376150000003463
    environment: g++
    memory: 3.804
    name: small_N_01
    status: AC
  - elapsed: 0.0023542969999965635
    environment: g++
    memory: 3.6
    name: small_N_02
    status: AC
  - elapsed: 0.002315761000005523
    environment: g++
    memory: 3.792
    name: small_N_03
    status: AC
  - elapsed: 0.0023238719999909563
    environment: g++
    memory: 3.768
    name: small_N_04
    status: AC
  - elapsed: 0.0023251650000020163
    environment: g++
    memory: 3.804
    name: small_N_05
    status: AC
  - elapsed: 0.0023008080000010978
    environment: g++
    memory: 3.812
    name: small_N_06
    status: AC
  - elapsed: 0.002274079000002871
    environment: g++
    memory: 3.812
    name: small_N_07
    status: AC
  - elapsed: 0.0022858060000032765
    environment: g++
    memory: 3.792
    name: small_N_08
    status: AC
  - elapsed: 0.0022724370000020144
    environment: g++
    memory: 3.82
    name: small_N_09
    status: AC
  - elapsed: 0.5568201349999953
    environment: g++
    memory: 23.036
    name: small_dense_00
    status: AC
  - elapsed: 0.012862228000003029
    environment: g++
    memory: 7.348
    name: small_dense_01
    status: AC
  - elapsed: 0.012494916000008516
    environment: g++
    memory: 7.352
    name: small_dense_02
    status: AC
  - elapsed: 0.06525521599999706
    environment: g++
    memory: 11.328
    name: small_dense_03
    status: AC
  - elapsed: 0.01276418400000523
    environment: g++
    memory: 7.352
    name: small_dense_04
    status: AC
  - elapsed: 0.9901931389999987
    environment: g++
    memory: 23.068
    name: small_dense_05
    status: AC
  - elapsed: 0.6406564370000041
    environment: g++
    memory: 23.068
    name: small_dense_06
    status: AC
  - elapsed: 0.012753357000008236
    environment: g++
    memory: 7.348
    name: small_dense_07
    status: AC
  - elapsed: 0.7258701149999922
    environment: g++
    memory: 23.064
    name: small_dense_08
    status: AC
  - elapsed: 0.06533575599999608
    environment: g++
    memory: 11.284
    name: small_dense_09
    status: AC
