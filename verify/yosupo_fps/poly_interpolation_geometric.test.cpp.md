...
data:
  ...
  - code: "// competitive-verifier: PROBLEM\n// https://judge.yosupo.jp/problem/polynomial_interpolation_on_geometric_sequence\n\
      ...
      \ << kendl;\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_fps/poly_interpolation_geometric.test.cpp\"\n//\
      ...
      \ w.inv(), iws = 1;\n    wc[0] = iwc[0] = 1;\n    for (int i = 1; i < n + m;\
      \ i++) {\n        wc[i] = ws * wc[i - 1];\n        ws *= w;\n    }\n    for\
      \ (int i = 1; i < std::max(n, m); i++) {\n        iwc[i] = iws * iwc[i - 1];\n\
      \        iws *= iw;\n    }\n    for (int i = 0; i < m; i++) f[i] *= iwc[i];\n\
      \    std::reverse(std::begin(f), std::end(f));\n    FPS g = f * wc;\n    std::vector<mint>\
      \ ret{std::begin(g) + m - 1, std::begin(g) + m + n - 1};\n    for (int i = 0;\
      \ i < n; i++) ret[i] *= iwc[i];\n    return ret;\n}\n\n} // namespace kk2\n\n\
      ...
      \    };\n    return rec(rec, 1);\n}\n\n// return FPS f s.t. f(ar^i) = y[i] for\
      \ all i\ntemplate <class FPS, class mint = typename FPS::value_type>\nFPS poly_interpolation_geo(const\
      ...
      \ & 1) w[n - 1] *= -1;\n    for (int i = n - 1; i > 0; i--) {\n        w[i -\
      \ 1] = w[i] * q * (-1) * s[idx1] * invs[idx1 - 1] * s[idx2] * invs[idx2 + 1];\n\
      \        q *= r;\n        idx1--;\n        idx2++;\n    }\n    for (int i =\
      \ 0; i < n; i++) w[i] *= y[i];\n\n    FPS g{begin(w), end(w)};\n    std::vector<mint>\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 8 \"verify/yosupo_fps/poly_interpolation_geometric.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\nint main()\
      \ {\n    int n;\n    kk2::mont998 a, r;\n    kin >> n >> a >> r;\n    vc<kk2::mont998>\
      \ y(n);\n    kin >> y;\n    kout << kk2::poly_interpolation_geo<FPS>(a, r, y)\
      \ << kendl;\n\n    return 0;\n}\n"
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0028585430000021006
    environment: g++
    memory: 3.832
    name: example_00
    status: AC
  - elapsed: 0.0023390860000063185
    environment: g++
    memory: 3.804
    name: example_01
    status: AC
  - elapsed: 5.161066804999962
    environment: g++
    memory: 44.54
    name: max_random_00
    status: AC
  - elapsed: 5.158454585000015
    environment: g++
    memory: 44.58
    name: max_random_01
    status: AC
  - elapsed: 5.1533712039999955
    environment: g++
    memory: 44.564
    name: max_random_02
    status: AC
  - elapsed: 0.0028563299999859737
    environment: g++
    memory: 3.792
    name: nar_0_00
    status: AC
  - elapsed: 0.0023543679999988854
    environment: g++
    memory: 3.644
    name: nar_0_01
    status: AC
  - elapsed: 0.0023207979999710915
    environment: g++
    memory: 3.808
    name: nar_0_02
    status: AC
  - elapsed: 0.002296671999999944
    environment: g++
    memory: 3.596
    name: nar_0_03
    status: AC
  - elapsed: 0.002259287999947901
    environment: g++
    memory: 3.808
    name: nar_0_04
    status: AC
  - elapsed: 0.0022954510000090522
    environment: g++
    memory: 3.66
    name: nar_0_05
    status: AC
  - elapsed: 0.002293478000012783
    environment: g++
    memory: 3.772
    name: nar_0_06
    status: AC
  - elapsed: 0.0022579650000125184
    environment: g++
    memory: 3.732
    name: nar_0_07
    status: AC
  - elapsed: 2.4940202369999724
    environment: g++
    memory: 24.052
    name: near_pow2_00
    status: AC
  - elapsed: 2.4922133950000216
    environment: g++
    memory: 24.06
    name: near_pow2_01
    status: AC
  - elapsed: 2.487093480999988
    environment: g++
    memory: 24.092
    name: near_pow2_02
    status: AC
  - elapsed: 3.2433105869999963
    environment: g++
    memory: 24.064
    name: near_pow2_03
    status: AC
  - elapsed: 3.2479897970000025
    environment: g++
    memory: 24.096
    name: near_pow2_04
    status: AC
  - elapsed: 1.820820222000009
    environment: g++
    memory: 24.808
    name: pow_rN_equal_1_00
    status: AC
  - elapsed: 3.613241535000043
    environment: g++
    memory: 41.496
    name: pow_rN_equal_1_01
    status: AC
  - elapsed: 0.2023805089999655
    environment: g++
    memory: 6.168
    name: pow_rN_equal_1_02
    status: AC
  - elapsed: 4.997974859999999
    environment: g++
    memory: 38.128
    name: random_00
    status: AC
  - elapsed: 5.1182675830000335
    environment: g++
    memory: 41.66
    name: random_01
    status: AC
  - elapsed: 0.5584558040000047
    environment: g++
    memory: 8.12
    name: random_02
    status: AC
  - elapsed: 0.00266178200001832
    environment: g++
    memory: 3.788
    name: small_00
    status: AC
  - elapsed: 0.0022862970000119276
    environment: g++
    memory: 3.604
    name: small_01
    status: AC
  - elapsed: 0.00232143900001347
    environment: g++
    memory: 3.816
    name: small_02
    status: AC
  - elapsed: 0.5866438059999837
    environment: g++
    memory: 48.556
    name: y0_00
    status: AC
