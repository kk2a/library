...
data:
  ...
  verifiedWith: []
documentation_of: verify/yosupo_fps/fps_pow_arb.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_fps/fps_pow_arb.test.cpp
- /verify/verify/yosupo_fps/fps_pow_arb.test.cpp.html
