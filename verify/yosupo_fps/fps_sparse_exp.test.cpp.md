...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/exp_of_formal_power_series_sparse\n\
      ...
      \n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_fps/fps_sparse_exp.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/exp_of_formal_power_series_sparse\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 6 \"verify/yosupo_fps/fps_sparse_exp.test.cpp\"\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0026684009999371483
    environment: g++
    memory: 3.772
    name: example_00
    status: AC
  - elapsed: 0.0022289240000645805
    environment: g++
    memory: 3.628
    name: example_01
    status: AC
  - elapsed: 0.002081540000062887
    environment: g++
    memory: 3.576
    name: example_02
    status: AC
  - elapsed: 0.43286960600005386
    environment: g++
    memory: 15.152
    name: max_random_00
    status: AC
  - elapsed: 0.4036954949999654
    environment: g++
    memory: 15.088
    name: max_random_01
    status: AC
  - elapsed: 0.3544285379999792
    environment: g++
    memory: 15.004
    name: max_random_02
    status: AC
  - elapsed: 0.3761585949999926
    environment: g++
    memory: 15.152
    name: max_random_03
    status: AC
  - elapsed: 0.3112680410000621
    environment: g++
    memory: 15.152
    name: max_random_04
    status: AC
  - elapsed: 0.046426463999978296
    environment: g++
    memory: 8.092
    name: min_K_00
    status: AC
  - elapsed: 0.054083382999920104
    environment: g++
    memory: 8.868
    name: min_K_01
    status: AC
  - elapsed: 0.1463798739999902
    environment: g++
    memory: 8.1
    name: random_00
    status: AC
  - elapsed: 0.19922587099995326
    environment: g++
    memory: 8.82
    name: random_01
    status: AC
  - elapsed: 0.2121354700000211
    environment: g++
    memory: 10.232
    name: random_02
    status: AC
  - elapsed: 0.05921073900003648
    environment: g++
    memory: 8.48
    name: random_03
    status: AC
  - elapsed: 0.10767395100003796
    environment: g++
    memory: 12.932
    name: random_04
    status: AC
  - elapsed: 0.00250588999995216
    environment: g++
    memory: 3.8
    name: small_N_00
    status: AC
  - elapsed: 0.0020866570000634965
    environment: g++
    memory: 3.628
    name: small_N_01
    status: AC
  - elapsed: 0.002136422999910792
    environment: g++
    memory: 3.788
    name: small_N_02
    status: AC
  - elapsed: 0.002175173999944491
    environment: g++
    memory: 3.752
    name: small_N_03
    status: AC
  - elapsed: 0.002121014999943327
    environment: g++
    memory: 3.772
    name: small_N_04
    status: AC
  - elapsed: 0.38653069300005427
    environment: g++
    memory: 15.152
    name: small_dense_00
    status: AC
  - elapsed: 0.43401822800001355
    environment: g++
    memory: 15.096
    name: small_dense_01
    status: AC
  - elapsed: 0.5596109399999705
    environment: g++
    memory: 15.1
    name: small_dense_02
    status: AC
  - elapsed: 0.11170273400000497
    environment: g++
    memory: 15.152
    name: small_dense_03
    status: AC
  - elapsed: 0.32999972300001446
    environment: g++
    memory: 15.116
    name: small_dense_04
    status: AC
  ...
  verifiedWith: []
documentation_of: verify/yosupo_fps/fps_sparse_exp.test.cpp
layout: document
---
