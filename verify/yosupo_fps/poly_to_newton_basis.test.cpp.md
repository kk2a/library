...
data:
  ...
  dependsOn: []
  embedded:
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/conversion_from_monomial_basis_to_newton_basis\n\
      ...
      \n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_fps/poly_to_newton_basis.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/conversion_from_monomial_basis_to_newton_basis\n\
      ...
      \n} // namespace kk2\n\n\n#line 1 \"fps/poly_to_newton_basis.hpp\"\n\n\n\n#line\
      \ 6 \"fps/poly_to_newton_basis.hpp\"\n\nnamespace kk2 {\n\n// return b s.t.\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 7 \"verify/yosupo_fps/poly_to_newton_basis.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\nint main()\
      \ {\n    int n;\n    kin >> n;\n    FPS f(n);\n    vc<kk2::mont998> p(n);\n\
      \    kin >> f >> p;\n    kout << kk2::convert_to_newton_basis(f, p) << kendl;\n\
      \n    return 0;\n}\n"
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0027275389999772415
    environment: g++
    memory: 3.628
    name: example_00
    status: AC
  - elapsed: 10.412997421
    environment: g++
    memory: 29.76
    name: max_random_00
    status: AC
  - elapsed: 10.409890379999979
    environment: g++
    memory: 29.832
    name: max_random_01
    status: AC
  - elapsed: 10.423041642999976
    environment: g++
    memory: 29.828
    name: max_random_02
    status: AC
  - elapsed: 4.637929149999991
    environment: g++
    memory: 16.572
    name: near_65536_00
    status: AC
  - elapsed: 4.640022176000002
    environment: g++
    memory: 16.448
    name: near_65536_01
    status: AC
  - elapsed: 4.641838183999994
    environment: g++
    memory: 16.444
    name: near_65536_02
    status: AC
  - elapsed: 4.946374748000039
    environment: g++
    memory: 20.044
    name: near_65536_03
    status: AC
  - elapsed: 4.938010890000044
    environment: g++
    memory: 20.092
    name: near_65536_04
    status: AC
  - elapsed: 7.336714852
    ...
    name: random_00
    status: AC
  - elapsed: 8.295707875000005
    environment: g++
    memory: 25.816
    name: random_01
    status: AC
  - elapsed: 0.5147623660000136
    environment: g++
    memory: 5.7
    name: random_02
    status: AC
  - elapsed: 0.002585705000001326
    environment: g++
    memory: 3.604
    name: small_00
    status: AC
  - elapsed: 0.0023581379999768615
    environment: g++
    memory: 3.652
    name: small_01
    status: AC
  - elapsed: 0.0023434210000345956
    environment: g++
    memory: 3.808
    name: small_02
    status: AC
