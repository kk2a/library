...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_fps/poly_to_newton_basis.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/conversion_from_monomial_basis_to_newton_basis\"\
    ...
    \ kk2\n\n\n#line 1 \"fps/poly_to_newton_basis.hpp\"\n\n\n\n#line 6 \"fps/poly_to_newton_basis.hpp\"\
    \n\nnamespace kk2 {\n\n// return b s.t.\n// f(X) = \\sum_{i = 0} ^ {n - 1} b_i\
    \ \\prod_{j = 0} ^ {i - 1} (X - p_j)\ntemplate <class FPS, class mint = typename\
    \ FPS::value_type>\nstd::vector<mint> convert_to_newton_basis(const FPS &f, const\
    \ std::vector<mint> &p) {\n    int n = (int)f.size();\n    assert(n == (int)p.size());\n\
