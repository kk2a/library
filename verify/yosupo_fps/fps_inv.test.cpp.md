...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/inv_of_formal_power_series\n\
    ...
    name: default
  - code: "#line 1 \"verify/yosupo_fps/fps_inv.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/inv_of_formal_power_series\n\n#line\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0026346140000441665
    environment: g++
    memory: 3.748
    name: example_00
    status: AC
  - elapsed: 2.033356819000005
    environment: g++
    memory: 11.616
    name: max_random_00
    status: AC
  - elapsed: 2.0324379300000146
    environment: g++
    memory: 11.616
    name: max_random_01
    status: AC
  - elapsed: 2.0340209539999705
    environment: g++
    memory: 11.644
    name: max_random_02
    status: AC
  - elapsed: 2.0330335610000247
    environment: g++
    memory: 11.688
    name: max_random_03
    status: AC
  - elapsed: 2.0327098300000443
    environment: g++
    memory: 11.692
    name: max_random_04
    status: AC
  - elapsed: 2.0306848809999565
    environment: g++
    memory: 11.648
    name: max_random_or_zero_00
    status: AC
  - elapsed: 0.9707210939999413
    environment: g++
    memory: 7.788
    name: near_262144_00
    status: AC
  - elapsed: 0.9728440690000753
    environment: g++
    memory: 7.724
    name: near_262144_01
    status: AC
  - elapsed: 1.9750093350000952
    environment: g++
    memory: 9.832
    name: near_262144_02
    status: AC
  - elapsed: 2.005916293000041
    environment: g++
    memory: 10.82
    name: random_00
    status: AC
  - elapsed: 2.0229928429999973
    environment: g++
    memory: 11.4
    name: random_01
    status: AC
  - elapsed: 0.21703825199995208
    environment: g++
    memory: 4.472
    name: random_02
    status: AC
  - elapsed: 2.0140538959999503
    environment: g++
    memory: 11.136
    name: random_03
    status: AC
  - elapsed: 1.9830080569998927
    environment: g++
    memory: 9.948
    name: random_04
    status: AC
  - elapsed: 0.0025147499999320644
    environment: g++
    memory: 3.728
    name: small_degree_00
    status: AC
  - elapsed: 0.0021748610000713597
    environment: g++
    memory: 3.78
    name: small_degree_01
    status: AC
  - elapsed: 0.0021100930000557128
    environment: g++
    memory: 3.792
    name: small_degree_02
    status: AC
  - elapsed: 0.002195263999965391
    environment: g++
    memory: 3.776
    name: small_degree_03
    status: AC
  - elapsed: 0.0021080259999735063
    environment: g++
    memory: 3.58
    name: small_degree_04
    status: AC
  - elapsed: 0.002134508000040114
    environment: g++
    memory: 3.78
    name: small_degree_05
    status: AC
  - elapsed: 0.002193980000015472
    environment: g++
    memory: 3.768
    name: small_degree_06
    status: AC
  - elapsed: 0.002159344999995483
    environment: g++
    memory: 3.76
    name: small_degree_07
    status: AC
  - elapsed: 0.00211966000006214
    environment: g++
    memory: 3.768
    name: small_degree_08
    status: AC
  - elapsed: 0.0021782190000294577
    environment: g++
    memory: 3.78
