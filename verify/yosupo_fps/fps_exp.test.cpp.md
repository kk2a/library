...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_fps/fps_exp.test.cpp\"\n#define PROBLEM \"\
    ...
    \ all(p) begin(p), end(p)\n\nvoid YES(bool b = 1) { std::cout << (b ? \"YES\"\
    \ : \"NO\") << '\\n'; }\nvoid NO(bool b = 1) { std::cout << (b ? \"NO\" : \"YES\"\
    ) << '\\n'; }\nvoid YESflush(bool b = 1) { std::cout << (b ? \"YES\" : \"NO\"\
    ) << std::endl; }\nvoid NOflush(bool b = 1) { std::cout << (b ? \"NO\" : \"YES\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/exp_of_formal_power_series\"\
    ...
    \ FPS = kk2::FormalPowerSeries<mint>;\n\nint main () {\n    int n;\n    cin >>\
    \ n;\n    FPS f(n);\n    rep (i, n) cin >> f[i];\n    auto g = f.exp();\n    for\
    \ (auto v : g) cout << v << \" \";\n    cout << endl;\n\n    return 0;\n}"
  dependsOn:
