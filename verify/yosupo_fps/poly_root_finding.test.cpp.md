...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_fps/poly_root_finding.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/polynomial_root_finding\" \n\n#line\
    ...
    \n\nnamespace kk2 {\n\nnamespace poly_gcd_impl {\n\ntemplate <class FPS> using\
    \ Vec = std::array<FPS, 2>;\n\ntemplate <class FPS> struct mat_poly {\n    FPS\
    \ a00, a01, a10, a11;\n\n    mat_poly() = default;\n\n    mat_poly(FPS a00_, FPS\
    \ a01_, FPS a10_, FPS a11_) : a00(a00_), a01(a01_), a10(a10_), a11(a11_) {}\n\n\
    ...
    \ = a.a10 * b[0] + a.a11 * b[1];\n    x0.shrink();\n    x1.shrink();\n    return\
    \ {x0, x1};\n};\n\ntemplate <class FPS> void inner_naive_gcd(mat_poly<FPS> &a,\
    \ Vec<FPS> &b) {\n    FPS quo = b[0] / b[1];\n    FPS rem = b[0] - quo * b[1];\n\
