...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/composition_of_formal_power_series_large\n\
    ...
    name: default
  - code: "#line 1 \"verify/yosupo_fps/fps_composition.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/composition_of_formal_power_series_large\n\
      ...
      \ + 1]; }\n        nr.ibut();\n        nr[0] -= 1;\n        q.assign(h * k,\
      \ 0);\n        for (int i = 0; i < 2 * k; i++) {\n            for (int j = 0;\
      \ j <= n / 2; j++) { q[i * h / 2 + j] = nr[i * h + j]; }\n        }\n      \
      \  auto p = self(self, q, n / 2, h / 2, k * 2);\n        FPS np(4 * h * k);\n\
      \        for (int i = 0; i < 2 * k; i++) {\n            for (int j = 0; j <=\
      \ n / 2; j++) { np[i * 2 * h + j * 2 + n % 2] = p[i * h / 2 + j]; }\n      \
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 7 \"verify/yosupo_fps/fps_composition.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\nint main()\
      \ {\n    int n;\n    kin >> n;\n    FPS f(n), g(n);\n    f.input(kin), g.input(kin);\n\
      \    kk2::composition(g, f).output(kout);\n    return 0;\n}\n"
    name: bundled
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0026505410000083884
    environment: g++
    memory: 3.8
    name: example_00
    status: AC
  - elapsed: 12.154239206
    environment: g++
    memory: 74.432
    name: hack2_00
    status: AC
  - elapsed: 12.140909069999992
    environment: g++
    memory: 74.448
    name: hack2_01
    status: AC
  - elapsed: 12.142563784999993
    environment: g++
    memory: 74.464
    name: hack2_02
    status: AC
  - elapsed: 11.536578311999989
    environment: g++
    memory: 74.428
    name: hack_00
    status: AC
  - elapsed: 11.46042335200002
    environment: g++
    memory: 74.464
    name: hack_01
    status: AC
  - elapsed: 11.892096771999974
    environment: g++
    memory: 74.464
    name: hack_02
    status: AC
  - elapsed: 12.205566641000019
    environment: g++
    memory: 74.468
    name: max_random_00
    status: AC
  - elapsed: 12.168933535000008
    environment: g++
    memory: 74.444
    name: max_random_01
    status: AC
  - elapsed: 12.14746035600001
    environment: g++
    memory: 74.468
    name: max_random_02
    status: AC
  - elapsed: 12.161089079999954
    environment: g++
    memory: 74.468
    name: max_random_03
    status: AC
  - elapsed: 12.190908499000045
    environment: g++
    memory: 74.468
    name: max_random_04
    status: AC
  - elapsed: 0.46698181800002203
    environment: g++
    memory: 6.972
    name: mid_00
    status: AC
  - elapsed: 0.46688067899998487
    environment: g++
    memory: 6.972
    name: mid_01
    status: AC
  - elapsed: 0.46598442599997725
    environment: g++
    memory: 6.972
    name: mid_02
    status: AC
  - elapsed: 0.2123442220000129
    environment: g++
    memory: 5.34
    name: mid_03
    status: AC
  - elapsed: 0.47841342399999576
    environment: g++
    memory: 6.972
    name: mid_04
    status: AC
  - elapsed: 12.153123821000008
    environment: g++
    memory: 74.268
    name: random_00
    status: AC
  - elapsed: 11.786589471000013
    environment: g++
    memory: 72.412
    name: random_01
    status: AC
  - elapsed: 5.4136448369999925
    environment: g++
    memory: 36.884
    name: random_02
    status: AC
  - elapsed: 5.309172168000032
    environment: g++
    memory: 36.36
    name: random_03
    status: AC
  - elapsed: 1.0841661329999965
    environment: g++
    memory: 11.068
    name: random_04
    status: AC
  - elapsed: 0.0026408909999986463
    environment: g++
    memory: 3.816
    name: small_00
    status: AC
  - elapsed: 0.002370432000020628
    environment: g++
    memory: 3.72
    name: small_01
    status: AC
  - elapsed: 0.002313879999974233
    environment: g++
    memory: 3.804
    name: small_02
    status: AC
  - elapsed: 0.0021915670000112186
    environment: g++
    memory: 3.804
    name: small_03
    status: AC
  - elapsed: 0.0022138520000112294
    environment: g++
    memory: 3.808
    name: small_04
    status: AC
  - elapsed: 0.0025143370000364484
    environment: g++
    memory: 3.788
    name: small_05
    status: AC
  - elapsed: 0.002438689000030081
    environment: g++
    memory: 3.8
    name: small_06
    status: AC
  - elapsed: 0.0023209360000464585
    environment: g++
    memory: 3.66
    name: small_07
    status: AC
  - elapsed: 0.0023007749999806038
    environment: g++
    memory: 3.824
    name: small_08
    status: AC
  - elapsed: 0.002181273999951827
    environment: g++
    memory: 3.808
    name: small_09
    status: AC
