...
data:
  ...
  - code: "// competitive-verifier: PROBLEM\n// https://judge.yosupo.jp/problem/multipoint_evaluation_on_geometric_sequence\n\
      ...
      \n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_fps/fps_multipoint_evaluation_geometric.test.cpp\"\
      \n// competitive-verifier: PROBLEM\n// https://judge.yosupo.jp/problem/multipoint_evaluation_on_geometric_sequence\n\
      \n#line 1 \"fps/chirp_Z.hpp\"\n\n\n\n#include <algorithm>\n#include <vector>\n\
      \nnamespace kk2 {\n\n// return f(aw^0), f(aw^1), ..., f(aw^(n - 1))\ntemplate\
      \ <class FPS, class mint = typename FPS::value_type>\nstd::vector<mint> ChirpZ(const\
      \ FPS &f_, mint w, int n = -1, mint a = 1) {\n    FPS f(f_.begin(), f_.end());\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 8 \"verify/yosupo_fps/fps_multipoint_evaluation_geometric.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\nint main()\
      \ {\n    int n, m;\n    kk2::mont998 a, r;\n    kin >> n >> m >> a >> r;\n \
      \   FPS f(n);\n    kin >> f;\n    kout << kk2::ChirpZ(f, r, m, a) << kendl;\n\
      \n    return 0;\n}\n"
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.14806628899998486
    environment: g++
    memory: 9.712
    name: a0_r01_00
    status: AC
  - elapsed: 0.3648740370000496
    environment: g++
    memory: 38.324
    name: a0_r01_01
    status: AC
  - elapsed: 0.37334701000008863
    environment: g++
    memory: 38.292
    name: a0_r01_02
    status: AC
  - elapsed: 0.16925279199995202
    environment: g++
    memory: 9.708
    name: a0_r01_03
    status: AC
  - elapsed: 3.0593066049999607
    environment: g++
    memory: 34.304
    name: a0_r01_04
    status: AC
  - elapsed: 0.0028674550000005183
    environment: g++
    memory: 3.656
    name: example_00
    status: AC
  - elapsed: 0.0023198710000542633
    environment: g++
    memory: 3.812
    name: example_01
    status: AC
  - elapsed: 3.435810778000018
    environment: g++
    memory: 34.312
    name: max_random_00
    status: AC
  - elapsed: 3.411265438999976
    environment: g++
    memory: 34.276
    name: max_random_01
    status: AC
  - elapsed: 3.419743988999926
    environment: g++
    memory: 34.28
    name: max_random_02
    status: AC
  - elapsed: 1.6443441330000041
    environment: g++
    memory: 18.9
    name: near_pow_of_2_00
    status: AC
  - elapsed: 1.6439998470000319
    environment: g++
    memory: 18.916
    name: near_pow_of_2_01
    status: AC
  - elapsed: 1.6591922409999142
    environment: g++
    memory: 18.892
    name: near_pow_of_2_02
    status: AC
  - elapsed: 1.6418624030000046
    environment: g++
    memory: 18.912
    name: near_pow_of_2_03
    status: AC
  - elapsed: 1.6447321299999658
    environment: g++
    memory: 18.952
    name: near_pow_of_2_04
    status: AC
  - elapsed: 1.6408136690000674
    environment: g++
    memory: 18.944
    name: near_pow_of_2_05
    status: AC
  - elapsed: 0.0026322009999830698
    environment: g++
    memory: 3.6
    name: nm_1_00
    status: AC
  - elapsed: 0.1531662879999658
    environment: g++
    memory: 15.692
    name: nm_1_01
    status: AC
  - elapsed: 1.686546081000074
    environment: g++
    memory: 21.98
    name: nm_1_02
    status: AC
  - elapsed: 3.2992483000000448
    environment: g++
    memory: 30.872
    name: random_00
    status: AC
  - elapsed: 3.3571908490000624
    environment: g++
    memory: 32.244
    name: random_01
    status: AC
  - elapsed: 0.8180161459999908
    environment: g++
    memory: 12.988
    name: random_02
    status: AC
  - elapsed: 0.0028656599999976606
    environment: g++
    memory: 3.752
    name: small_random_00
    status: AC
  - elapsed: 0.0024994400000650785
    environment: g++
    memory: 3.788
    name: small_random_01
    status: AC
  - elapsed: 0.002474287000040931
    environment: g++
    memory: 3.612
