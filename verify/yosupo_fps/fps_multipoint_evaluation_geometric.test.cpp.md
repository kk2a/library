...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_fps/fps_multipoint_evaluation_geometric.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo_fps/fps_multipoint_evaluation_geometric.test.cpp
- /verify/verify/yosupo_fps/fps_multipoint_evaluation_geometric.test.cpp.html
