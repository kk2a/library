...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/multipoint_evaluation\n\
      ...
      \    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_fps/fps_multipoint_evaluation.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/multipoint_evaluation\n\n#line 1 \"\
      fps/fps_ntt_friendly.hpp\"\n\n\n\n#include <algorithm>\n#include <cassert>\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 7 \"verify/yosupo_fps/fps_multipoint_evaluation.test.cpp\"\
      \nusing namespace std;\n\nusing FPS = kk2::FPSNTT<kk2::mont998>;\n\nint main()\
      \ {\n    int n, m;\n    kin >> n >> m;\n    FPS f(n);\n    vc<kk2::mont998>\
      \ p(m);\n    kin >> f >> p;\n    kout << kk2::MultiEval(p, f) << kendl;\n\n\
      \    return 0;\n}\n"
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002974601999994775
    environment: g++
    memory: 3.832
    name: example_00
    status: AC
  - elapsed: 0.002680664000024535
    environment: g++
    memory: 3.808
    name: example_01
    status: AC
  - elapsed: 0.0026265439999519913
    environment: g++
    memory: 3.832
    name: issue_1287_00
    status: AC
  - elapsed: 11.83417595000003
    environment: g++
    memory: 34.02
    name: issue_1287_cpp_00
    status: AC
  - elapsed: 11.813041233999968
    environment: g++
    memory: 34.068
    name: issue_1287_cpp_01
    status: AC
  - elapsed: 11.807189533000042
    environment: g++
    memory: 34.024
    name: max_random_00
    status: AC
  - elapsed: 11.802226598000004
    environment: g++
    memory: 33.98
    name: max_random_01
    status: AC
  - elapsed: 2.1707271669999955
    environment: g++
    memory: 13.812
    name: random_00
    status: AC
  - elapsed: 1.8600038710000035
    environment: g++
    memory: 11.268
    name: random_01
    status: AC
  - elapsed: 9.706185609000045
    environment: g++
    memory: 29.968
    name: random_02
    status: AC
  - elapsed: 0.0026020370000310322
    environment: g++
    memory: 3.78
    name: zero_00
    status: AC
