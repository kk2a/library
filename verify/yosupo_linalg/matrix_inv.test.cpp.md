...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/inverse_matrix\n\
      ...
      \ << -1 << \"\\n\";\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_linalg/matrix_inv.test.cpp\"\n// competitive-verifier:\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 6 \"verify/yosupo_linalg/matrix_inv.test.cpp\"\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0017061070000181644
    environment: g++
    memory: 3.86
    name: anti55588_00
    status: AC
  - elapsed: 0.001547380999966208
    environment: g++
    memory: 3.864
    name: example_00
    status: AC
  - elapsed: 0.0014280489999691781
    environment: g++
    memory: 3.764
    name: example_01
    status: AC
  - elapsed: 0.0015379780000444043
    environment: g++
    memory: 3.9
    name: example_02
    status: AC
  - elapsed: 1.3019729530000177
    environment: g++
    memory: 7.412
    name: lowrank_max_random_00
    status: AC
  - elapsed: 1.0242121370000064
    environment: g++
    memory: 7.356
    name: lowrank_max_random_01
    status: AC
  - elapsed: 1.6829959089999988
    environment: g++
    memory: 7.54
    name: lowrank_max_random_02
    status: AC
  - elapsed: 1.022834615000022
    environment: g++
    memory: 7.268
    name: lowrank_max_random_03
    status: AC
  - elapsed: 1.284004574999983
    environment: g++
    memory: 7.412
    name: lowrank_max_random_04
    status: AC
  - elapsed: 1.9993377050000163
    environment: g++
    memory: 7.696
    name: max_random_00
    status: AC
  - elapsed: 1.954178593999984
    environment: g++
    memory: 7.692
    name: max_random_01
    status: AC
  - elapsed: 1.9317801889999942
    environment: g++
    memory: 7.688
    name: max_random_02
    status: AC
  - elapsed: 1.9543990409999878
    environment: g++
    memory: 7.668
    name: max_random_03
    status: AC
  - elapsed: 1.9539681339999788
    environment: g++
    memory: 7.696
    name: max_random_04
    status: AC
  - elapsed: 0.025156393000031585
    environment: g++
    memory: 7.54
    name: perm_max_random_00
    status: AC
  - elapsed: 0.02444264299998622
    environment: g++
    memory: 7.54
    name: perm_max_random_01
    status: AC
  - elapsed: 0.024820787000010114
    environment: g++
    memory: 7.668
    name: perm_max_random_02
    status: AC
  - elapsed: 0.023643058999994082
    environment: g++
    memory: 7.54
    name: perm_max_random_03
    status: AC
  - elapsed: 0.024327018000008138
    environment: g++
    memory: 7.54
    name: perm_max_random_04
    status: AC
  - elapsed: 0.09732584099998576
    environment: g++
    memory: 4.628
    name: random_00
    status: AC
  - elapsed: 0.12784027000003562
    environment: g++
    memory: 4.676
    name: random_01
    status: AC
  - elapsed: 0.013248839999960182
    environment: g++
    memory: 4.104
    name: random_02
    status: AC
  - elapsed: 0.11688208200001782
    environment: g++
    memory: 4.608
    name: random_03
    status: AC
  - elapsed: 0.0016939390000061394
    environment: g++
    memory: 3.856
    name: random_04
    status: AC
  - elapsed: 0.0016036999999755608
    environment: g++
    memory: 3.748
    name: signed_overflow_00
    status: AC
  - elapsed: 0.0014636530000302628
    environment: g++
    memory: 3.88
