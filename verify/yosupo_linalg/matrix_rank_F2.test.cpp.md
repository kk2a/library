...
data:
  ...
  - type_traits/io.hpp
  embedded:
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/matrix_rank_mod_2\n\
    ...
    name: default
  - code: "#line 1 \"verify/yosupo_linalg/matrix_rank_F2.test.cpp\"\n// competitive-verifier:\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 5 \"verify/yosupo_linalg/matrix_rank_F2.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    int n, m;\n    kin >> n >> m;\n\
      \    bool is_swap = false;\n    if (n > m) {\n        is_swap = true;\n    \
      \    swap(n, m);\n    }\n\n    kk2::MatrixF2 a(n, m);\n    if (is_swap) {\n\
      \        rep (j, m) {\n            string s;\n            kin >> s;\n      \
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0024935420000247177
    environment: g++
    memory: 3.848
    name: example_00
    status: AC
  - elapsed: 0.0017706069999690044
    environment: g++
    memory: 3.752
    name: example_01
    status: AC
  - elapsed: 0.0017132629999991877
    environment: g++
    memory: 3.648
    name: example_02
    status: AC
  - elapsed: 0.5633999190000054
    environment: g++
    memory: 7.8
    name: lowrank_00
    status: AC
  - elapsed: 0.9869208610000442
    environment: g++
    memory: 7.612
    name: lowrank_01
    status: AC
  - elapsed: 0.574136899999985
    environment: g++
    memory: 7.744
    name: lowrank_02
    status: AC
  - elapsed: 1.0539731169999982
    environment: g++
    memory: 8.084
    name: lowrank_03
    status: AC
  - elapsed: 0.6383771889999821
    environment: g++
    memory: 7.872
    name: lowrank_04
    status: AC
  - elapsed: 1.0916658439999765
    environment: g++
    memory: 8.204
    name: lowrank_05
    status: AC
  - elapsed: 0.5679341160000035
    environment: g++
    memory: 7.8
    name: lowrank_06
    status: AC
  - elapsed: 0.9550151230000097
    environment: g++
    memory: 7.8
    name: lowrank_07
    status: AC
  - elapsed: 0.5967353660000185
    environment: g++
    memory: 7.792
    name: lowrank_08
    status: AC
  - elapsed: 0.9789950840000188
    environment: g++
    memory: 7.672
    name: lowrank_09
    status: AC
  - elapsed: 0.43892458599998463
    environment: g++
    memory: 41.532
    name: max_00
    status: AC
  - elapsed: 0.44462817999999515
    environment: g++
    memory: 30.652
    name: max_01
    status: AC
  - elapsed: 0.44792834099996526
    environment: g++
    memory: 20.148
    name: max_02
    status: AC
  - elapsed: 0.9674118020000151
    environment: g++
    memory: 8.184
    name: max_03
    status: AC
  - elapsed: 0.9465710289999834
    environment: g++
    memory: 8.056
    name: max_04
    status: AC
  - elapsed: 1.3182692429999747
    environment: g++
    memory: 8.184
    name: max_05
    status: AC
  - elapsed: 1.2962044639999704
    environment: g++
    memory: 7.732
    name: max_06
    status: AC
  - elapsed: 1.5287339160000215
    environment: g++
    memory: 7.724
    name: max_07
    status: AC
  - elapsed: 2.314128167999968
    environment: g++
    memory: 7.712
    name: max_08
    status: AC
  - elapsed: 0.35759138299999904
    environment: g++
    memory: 6.668
    name: random_00
    status: AC
  - elapsed: 0.19659689399998115
    environment: g++
    memory: 4.724
    name: random_01
    status: AC
  - elapsed: 0.2834288059999608
    environment: g++
    memory: 6.136
    name: random_02
    status: AC
  - elapsed: 0.14933210499998495
    environment: g++
    memory: 4.636
    name: random_03
    status: AC
  - elapsed: 0.11582019100001162
    environment: g++
    memory: 4.608
    name: random_04
    status: AC
  - elapsed: 0.17277855800000452
    environment: g++
    memory: 4.856
    name: random_05
    status: AC
  - elapsed: 0.21080166000001554
    environment: g++
    memory: 5.24
    name: random_06
    status: AC
  - elapsed: 0.047243179000020064
    environment: g++
    memory: 4.404
    name: random_07
    status: AC
  - elapsed: 0.0017161430000669498
    environment: g++
    memory: 3.852
    name: zero_00
    status: AC
  - elapsed: 0.001615370999957122
    environment: g++
    memory: 3.852
    name: zero_01
    status: AC
  - elapsed: 0.0016134759999886228
    environment: g++
    memory: 3.764
    name: zero_02
    status: AC
  - elapsed: 0.0015721979999625546
    environment: g++
    memory: 3.74
    name: zero_03
    status: AC
  - elapsed: 1.3384396080000442
    environment: g++
    memory: 3.96
    name: zero_04
    status: AC
