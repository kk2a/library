...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_linalg/matrix_product.test.cpp\"\n#define\
...
layout: document
redirect_from:
- /verify/verify/yosupo_linalg/matrix_product.test.cpp
- /verify/verify/yosupo_linalg/matrix_product.test.cpp.html
