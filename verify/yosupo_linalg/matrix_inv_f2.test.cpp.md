...
data:
  ...
  - type_traits/io.hpp
  embedded:
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/inverse_matrix_mod_2\n\
      \n#include \"../../matrix/matrix_F2.hpp\"\n#include \"../../template/template.hpp\"\
      \nusing namespace std;\n\nint main() {\n    int n;\n    kin >> n;\n    kk2::MatrixF2\
      \ a(n, n);\n    if (auto const inv = a.input(kin).inv()) inv->output(kout);\n\
      \    else kout << -1 << \"\\n\";\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_linalg/matrix_inv_f2.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/inverse_matrix_mod_2\n\n#line 1 \"\
      matrix/matrix_F2.hpp\"\n\n\n\n#include <algorithm>\n#include <cassert>\n#include\
      \ <iostream>\n#include <optional>\n#include <string>\n#include <vector>\n\n\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0024728879999997844
    environment: g++
    memory: 3.676
    name: example_00
    status: AC
  - elapsed: 0.002109168000004047
    environment: g++
    memory: 3.848
    name: example_01
    status: AC
  - elapsed: 0.0020520830000236856
    environment: g++
    memory: 3.828
    name: example_02
    status: AC
  - elapsed: 0.7936553499999945
    environment: g++
    memory: 10.312
    name: lowrank_max_random_00
    status: AC
  - elapsed: 0.7946999310000251
    environment: g++
    memory: 10.296
    name: lowrank_max_random_01
    status: AC
  - elapsed: 0.798225374000026
    environment: g++
    memory: 10.304
    name: lowrank_max_random_02
    status: AC
  - elapsed: 1.286603968999998
    environment: g++
    memory: 10.312
    name: lowrank_max_random_03
    status: AC
  - elapsed: 0.9715552029999799
    environment: g++
    memory: 10.312
    name: lowrank_max_random_04
    status: AC
  - elapsed: 0.8303904339999804
    environment: g++
    memory: 10.312
    name: lowrank_max_random_05
    status: AC
  - elapsed: 0.7947535819999985
    environment: g++
    memory: 10.312
    name: lowrank_max_random_06
    status: AC
  - elapsed: 0.8012389179999673
    environment: g++
    memory: 10.276
    name: lowrank_max_random_07
    status: AC
  - elapsed: 4.652497074999985
    environment: g++
    memory: 12.488
    name: max_fullrank_00
    status: AC
  - elapsed: 4.642414346999999
    environment: g++
    memory: 12.436
    name: max_fullrank_01
    status: AC
  - elapsed: 4.651873436000017
    environment: g++
    memory: 12.452
    name: max_fullrank_02
    status: AC
  - elapsed: 4.660747471000036
    environment: g++
    memory: 12.488
    name: max_fullrank_03
    status: AC
  - elapsed: 4.072291777000032
    environment: g++
    memory: 10.252
    name: max_random_00
    status: AC
  - elapsed: 4.677564683000014
    environment: g++
    memory: 12.48
    name: max_random_01
    status: AC
  - elapsed: 4.076039132000005
    environment: g++
    memory: 10.312
    name: max_random_02
    status: AC
  - elapsed: 4.047522947999994
    environment: g++
    memory: 10.312
    name: max_random_03
    status: AC
  - elapsed: 0.7913279719999764
    environment: g++
    memory: 10.184
    name: perm_max_random_00
    status: AC
  - elapsed: 0.7948028589999581
    environment: g++
    memory: 10.184
    name: perm_max_random_01
    status: AC
  - elapsed: 0.05509607300001562
    environment: g++
    memory: 4.208
    name: random_00
    status: AC
  - elapsed: 0.007984952000015255
    environment: g++
    memory: 3.968
    name: random_01
    status: AC
  - elapsed: 0.0028454780000402025
    environment: g++
    memory: 3.82
    name: random_02
    status: AC
  - elapsed: 2.2241534659999616
    environment: g++
    memory: 8.008
    name: random_03
    status: AC
  - elapsed: 0.07383366499999511
    environment: g++
    memory: 4.272
    name: random_fullrank_00
    status: AC
  - elapsed: 0.007982748000017637
    environment: g++
    memory: 3.908
    name: random_fullrank_01
    status: AC
  - elapsed: 0.003447918999995636
    environment: g++
    memory: 3.824
    name: random_fullrank_02
    status: AC
  - elapsed: 2.6072783429999618
    environment: g++
    memory: 9.496
    name: random_fullrank_03
    status: AC
  - elapsed: 0.0023162070000353197
    environment: g++
    memory: 3.748
    name: small_random_00
    status: AC
  - elapsed: 0.0021045889999982137
    environment: g++
    memory: 3.844
    name: small_random_01
    status: AC
  - elapsed: 0.0021230159999845455
    environment: g++
    memory: 3.812
    name: small_random_02
    status: AC
  - elapsed: 0.002086036999969565
    environment: g++
    memory: 3.784
    name: small_random_03
    status: AC
  - elapsed: 0.002088414000013472
    environment: g++
    memory: 3.824
    name: small_random_04
    status: AC
  - elapsed: 0.0021193890000290594
    environment: g++
    memory: 3.836
    name: small_random_05
    status: AC
  - elapsed: 0.0021075870000117902
    environment: g++
    memory: 3.816
    name: small_random_06
    status: AC
  - elapsed: 0.0020553879999738456
    environment: g++
    memory: 3.824
