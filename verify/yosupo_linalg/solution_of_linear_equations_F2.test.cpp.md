...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/system_of_linear_equations_mod_2\n\
      ...
      \ (const auto res = a.solve(b.inplace_transpose())) {\n        kout << res->get_h()\
      \ - 1 << \"\\n\";\n        res->output(kout);\n    } else {\n        kout <<\
      \ -1 << \"\\n\";\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_linalg/solution_of_linear_equations_F2.test.cpp\"\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0022338640000043597
    environment: g++
    memory: 3.928
    name: example_00
    status: AC
  - elapsed: 0.0015825670000140235
    environment: g++
    memory: 3.96
    name: example_01
    status: AC
  - elapsed: 0.001557233999960772
    environment: g++
    memory: 3.968
    name: example_02
    status: AC
  - elapsed: 0.8390120810000781
    environment: g++
    memory: 12.716
    name: max_lowrank_00
    status: AC
  - elapsed: 0.5890653690000818
    environment: g++
    memory: 12.688
    name: max_lowrank_01
    status: AC
  - elapsed: 0.885920069000008
    environment: g++
    memory: 12.688
    name: max_lowrank_02
    status: AC
  - elapsed: 0.7511098319999974
    environment: g++
    memory: 12.688
    name: max_lowrank_03
    status: AC
  - elapsed: 1.4554803050000373
    environment: g++
    memory: 12.628
    name: max_lowrank_04
    status: AC
  - elapsed: 0.5642299649999813
    environment: g++
    memory: 12.688
    name: max_lowrank_05
    status: AC
  - elapsed: 0.8778408609999815
    environment: g++
    memory: 12.688
    name: max_lowrank_06
    status: AC
  - elapsed: 0.6220612359999222
    environment: g++
    memory: 12.716
    name: max_lowrank_07
    status: AC
  - elapsed: 1.0823497630000247
    environment: g++
    memory: 12.68
    name: max_lowrank_08
    status: AC
  - elapsed: 1.3909919870000067
    environment: g++
    memory: 12.632
    name: max_lowrank_09
    status: AC
  - elapsed: 1.3816464630000382
    environment: g++
    memory: 12.68
    name: max_random_00
    status: AC
  - elapsed: 1.4249290010000095
    environment: g++
    memory: 12.688
    name: max_random_01
    status: AC
  - elapsed: 1.4518055749999803
    environment: g++
    memory: 12.688
    name: max_random_02
    status: AC
  - elapsed: 1.3911935979999726
    environment: g++
    memory: 12.688
    name: max_random_03
    status: AC
  - elapsed: 1.3753226329999961
    environment: g++
    memory: 12.632
    name: max_random_04
    status: AC
  - elapsed: 0.005625349000069946
    environment: g++
    memory: 4.552
    name: max_small_00
    status: AC
  - elapsed: 0.005262451000021429
    environment: g++
    memory: 4.504
    name: max_small_01
    status: AC
  - elapsed: 0.07415450199994211
    environment: g++
    memory: 4.652
    name: random_00
    status: AC
  - elapsed: 0.2239253950000375
    environment: g++
    memory: 5.888
    name: random_01
    status: AC
  - elapsed: 0.04427342000008139
    environment: g++
    memory: 4.536
    name: random_02
    status: AC
  - elapsed: 0.21680412900002466
    environment: g++
    memory: 5.796
    name: random_03
    status: AC
  - elapsed: 0.10339223699998001
    environment: g++
    memory: 5.008
    name: random_04
    status: AC
  - elapsed: 0.2818322570000191
    environment: g++
    memory: 6.4
    name: small_max_00
    status: AC
  - elapsed: 0.0030057650000117064
    environment: g++
    memory: 3.94
    name: small_max_01
    status: AC
  - elapsed: 0.0015807190000032278
    environment: g++
    memory: 3.892
    name: small_random_00
    status: AC
  - elapsed: 0.0015757030000713712
    environment: g++
    memory: 3.896
    name: small_random_01
    status: AC
  - elapsed: 0.0015237429998933294
    environment: g++
    memory: 3.88
    name: small_random_02
    status: AC
  - elapsed: 0.0014939010000034614
    environment: g++
    memory: 3.764
    name: small_random_03
    status: AC
  - elapsed: 0.0015250359999754437
    environment: g++
    memory: 3.92
    name: small_random_04
    status: AC
  - elapsed: 0.0015403689999402559
    environment: g++
    memory: 3.936
    name: smallest_00
    status: AC
  - elapsed: 0.0014924270000165052
    environment: g++
    memory: 3.848
    name: smallest_01
    status: AC
  - elapsed: 0.0015306149999787522
    environment: g++
    memory: 3.892
    name: smallest_02
    status: AC
  - elapsed: 0.0015268890000470492
    environment: g++
    memory: 3.884
    name: smallest_03
    status: AC
