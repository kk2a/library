...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/vertex_add_subtree_sum\n\
      ...
      \            bit.add(l, x);\n        } else {\n            int u;\n        \
      \    kin >> u;\n            i64 res = 0;\n            et.subtree_query(u, 1,\
      \ [&](int l, int r) { res += bit.sum(l, r); });\n            kout << res <<\
      \ \"\\n\";\n        }\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_graph/tree_vertex_add_subtree_sum_1.test.cpp\"\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 7 \"verify/yosupo_graph/tree_vertex_add_subtree_sum_1.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    int n, q;\n    kin >> n >> q;\n\
      \    vc<int> a(n);\n    vc<int> p(n - 1);\n    kin >> a >> p;\n    kk2::AdjList\
      \ g(n);\n    rep(i, n - 1) g.add_edge(i + 1, p[i]);\n\n    kk2::EulerTour et(g);\n\
      \    kk2::BinaryIndexedTree<i64> bit(et.id + 1);\n    rep(i, n) {\n        auto\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0026474610000093435
    environment: g++
    memory: 3.808
    name: example_00
    status: AC
  - elapsed: 1.6421109380000019
    environment: g++
    memory: 386.36
    name: line_00
    status: AC
  - elapsed: 1.664795080999994
    environment: g++
    memory: 386.364
    name: line_01
    status: AC
  - elapsed: 1.88363357099999
    environment: g++
    memory: 321.664
    name: max_random_00
    status: AC
  - elapsed: 1.8799073509999857
    environment: g++
    memory: 321.496
    name: max_random_01
    status: AC
  - elapsed: 1.8321725929999957
    environment: g++
    memory: 321.404
    name: max_random_02
    status: AC
  - elapsed: 1.414217659000002
    environment: g++
    memory: 252.248
    name: random_00
    status: AC
  - elapsed: 1.6775968139999975
    environment: g++
    memory: 298.108
    name: random_01
    status: AC
  - elapsed: 0.2682208159999959
    environment: g++
    memory: 33.732
    name: random_02
    status: AC
  - elapsed: 1.4182302700000093
    environment: g++
    memory: 276.836
    name: random_03
    status: AC
  - elapsed: 0.9365241360000027
    environment: g++
    memory: 180.556
    name: random_04
    status: AC
  - elapsed: 0.004400347000000693
    environment: g++
    memory: 4.148
    name: small_00
    status: AC
  - elapsed: 0.002826353000017434
    environment: g++
    memory: 3.928
    name: small_01
    status: AC
  - elapsed: 0.00262597599999026
    environment: g++
    memory: 3.82
    name: small_02
    status: AC
  - elapsed: 0.00519873500002177
    environment: g++
    memory: 4.144
    name: small_03
    status: AC
  - elapsed: 0.0034423730000128216
    environment: g++
    memory: 4.064
    name: small_04
    status: AC
