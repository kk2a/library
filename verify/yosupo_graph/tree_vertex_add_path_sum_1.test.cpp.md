...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/vertex_add_path_sum\n\
      ...
      \            kin >> u >> v;\n            i64 res = 0;\n            et.path_query(u,\
      \ v, 1, [&](int l, int r) { res += bit.sum(l, r); });\n            kout << res\
      \ << \"\\n\";\n        }\n    }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_graph/tree_vertex_add_path_sum_1.test.cpp\"\n//\
      ...
      \n\n#include <algorithm>\n#line 6 \"graph/tree/euler_tour.hpp\"\n#include <functional>\n\
  ...
  requiredBy: []
  testcases:
  - elapsed: 1.9598958489999916
    environment: g++
    memory: 367.032
    name: almost_line_00
    status: AC
  - elapsed: 1.921979308999994
    environment: g++
    memory: 360.9
    name: almost_line_01
    status: AC
  - elapsed: 0.002531062999992173
    environment: g++
    memory: 3.624
    name: example_00
    status: AC
  - elapsed: 1.8992614600000195
    environment: g++
    memory: 357.9
    name: line_00
    status: AC
  - elapsed: 1.9103274800000065
    environment: g++
    memory: 379.248
    name: line_01
    status: AC
  - elapsed: 1.5289367150000146
    environment: g++
    memory: 316.112
    name: long-path-decomposition_killer_00
    status: AC
  - elapsed: 1.8387996619999853
    environment: g++
    memory: 319.656
    name: max_random_00
    status: AC
  - elapsed: 1.847510561000007
    environment: g++
    memory: 319.652
    name: max_random_01
    status: AC
  - elapsed: 1.8453612229999976
    environment: g++
    memory: 319.62
    name: max_random_02
    status: AC
  - elapsed: 1.430412553000025
    environment: g++
    memory: 250.128
    name: random_00
    status: AC
  - elapsed: 1.6698751939999852
    environment: g++
    memory: 296.328
    name: random_01
    status: AC
  - elapsed: 0.30946230200001423
    environment: g++
    memory: 33.5
    name: random_02
    status: AC
  - elapsed: 1.3342481829999997
    environment: g++
    memory: 275.028
    name: random_03
    status: AC
  - elapsed: 0.8907193510000013
    environment: g++
    memory: 178.716
    name: random_04
    status: AC
  - elapsed: 0.0037903610000000754
    environment: g++
    memory: 4.076
    name: small_00
    status: AC
  - elapsed: 0.002571794999994381
    environment: g++
    memory: 3.908
    name: small_01
    status: AC
  - elapsed: 0.002400372000010975
    environment: g++
    memory: 3.824
    name: small_02
    status: AC
  - elapsed: 0.0025446940000222185
    environment: g++
    memory: 3.804
    name: small_03
    status: AC
  - elapsed: 0.0034641900000167425
    environment: g++
    memory: 4.064
    name: small_04
    status: AC
