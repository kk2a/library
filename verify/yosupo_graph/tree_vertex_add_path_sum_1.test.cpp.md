...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/vertex_add_path_sum\n\
      ...
      \ 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_graph/tree_vertex_add_path_sum_1.test.cpp\"\n//\
      ...
      \n\n\n\n#line 6 \"graph/detail/adjacency_list_base.hpp\"\n\n#line 1 \"graph/edge.hpp\"\
      ...
      \ data;\n\n    T sum(int r) {\n        T s{};\n        for (; r > 0; r -= r\
      \ & -r) s += data[r - 1];\n        return s;\n    }\n};\n\n} // namespace kk2\n\
      \n\n#line 7 \"verify/yosupo_graph/tree_vertex_add_path_sum_1.test.cpp\"\nusing\
      \ namespace std;\n\nint main() {\n    int n, q;\n    kin >> n >> q;\n    vc<i64>\
      \ a(n);\n    kin >> a;\n    kk2::AdjList g(n, n - 1, kin);\n\n    kk2::EulerTour\
      \ et(g);\n    kk2::BinaryIndexedTree<i64> bit(et.id + 1);\n    rep (i, n) {\n\
      \        auto [l, r] = et.get_node_idx(i);\n        bit.add(l, a[i]), bit.add(r,\
      \ -a[i]);\n    }\n    rep (q) {\n        int type;\n        kin >> type;\n \
      \       if (type == 0) {\n            int p, x;\n            kin >> p >> x;\n\
      \            auto [l, r] = et.get_node_idx(p);\n            bit.add(l, x), bit.add(r,\
      \ -x);\n        } else {\n            int u, v;\n            kin >> u >> v;\n\
      \            i64 res = 0;\n            et.path_query(u, v, 1, [&](int l, int\
      \ r) {\n                res += bit.sum(l, r);\n            });\n           \
      \ kout << res << \"\\n\";\n        }\n    }\n\n    return 0;\n}\n"
    name: bundled
  isFailed: false
  ...
  requiredBy: []
  testcases:
  - elapsed: 2.0620745679999857
    environment: g++
    memory: 366.824
    name: almost_line_00
    status: AC
  - elapsed: 2.0129443680000065
    environment: g++
    memory: 360.888
    name: almost_line_01
    status: AC
  - elapsed: 0.00262928999998735
    environment: g++
    memory: 3.804
    name: example_00
    status: AC
  - elapsed: 1.9804505000000177
    environment: g++
    memory: 357.884
    name: line_00
    status: AC
  - elapsed: 2.0389514940000026
    environment: g++
    memory: 379.212
    name: line_01
    status: AC
  - elapsed: 1.5509327860000042
    environment: g++
    memory: 316.12
    name: long-path-decomposition_killer_00
    status: AC
  - elapsed: 2.0229288790000055
    environment: g++
    memory: 319.608
    name: max_random_00
    status: AC
  - elapsed: 2.0681584069999985
    environment: g++
    memory: 319.66
    name: max_random_01
    status: AC
  - elapsed: 2.043660023000001
    environment: g++
    memory: 319.66
    name: max_random_02
    status: AC
  - elapsed: 1.6024083279999957
    environment: g++
    memory: 250.132
    name: random_00
    status: AC
  - elapsed: 1.8505850429999953
    environment: g++
    memory: 296.364
    name: random_01
    status: AC
  - elapsed: 0.3279642980000119
    environment: g++
    memory: 33.532
    name: random_02
    status: AC
  - elapsed: 1.4848702150000008
    environment: g++
    memory: 275.032
    name: random_03
    status: AC
  - elapsed: 0.9773389419999887
    environment: g++
    memory: 178.768
    name: random_04
    status: AC
  - elapsed: 0.004214877000009665
    environment: g++
    memory: 4.064
    name: small_00
    status: AC
  - elapsed: 0.0027628770000092118
    environment: g++
    memory: 3.96
    name: small_01
    status: AC
  - elapsed: 0.002548793000016758
    environment: g++
    memory: 3.632
    name: small_02
    status: AC
  - elapsed: 0.002731428999993568
    environment: g++
    memory: 3.94
    name: small_03
    status: AC
  - elapsed: 0.003596917999999505
    environment: g++
    memory: 4.072
    name: small_04
    status: AC
