...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_graph/tree_cartesian.test.cpp\"\n#define PROBLEM\
...
layout: document
redirect_from:
- /verify/verify/yosupo_graph/tree_cartesian.test.cpp
- /verify/verify/yosupo_graph/tree_cartesian.test.cpp.html
