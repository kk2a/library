...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/scc\n\n\
      ...
      \ << \"\\n\"; }\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_graph/graph_scc.test.cpp\"\n// competitive-verifier:\
      ...
      \ EdgeRange = std::ranges::input_range<R> &&\n                    Edge<std::ranges::range_value_t<R>>;\n\
      ...
      \ \"graph/topological_sort.hpp\"\n\nnamespace kk2 {\n\ntemplate <graph::VertexAdjacency\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002682382999978472
    environment: g++
    memory: 3.832
    name: example_00
    status: AC
  - elapsed: 0.5093410210000684
    environment: g++
    memory: 97.136
    name: large_cycle_00
    status: AC
  - elapsed: 0.9942346799999768
    environment: g++
    memory: 113.072
    name: max_random_00
    status: AC
  - elapsed: 1.0255351049999035
    environment: g++
    memory: 113.188
    name: max_random_01
    status: AC
  - elapsed: 0.984499454999991
    environment: g++
    memory: 113.204
    name: max_random_02
    status: AC
  - elapsed: 1.0335420010000007
    environment: g++
    memory: 113.2
    name: max_random_03
    status: AC
  - elapsed: 0.9937421880000556
    environment: g++
    memory: 113.164
    name: max_random_04
    status: AC
  - elapsed: 0.7704575720000548
    environment: g++
    memory: 90.208
    name: random_00
    status: AC
  - elapsed: 0.8591365789999372
    environment: g++
    memory: 102.724
    name: random_01
    status: AC
  - elapsed: 0.22240884200004984
    environment: g++
    memory: 24.476
    name: random_02
    status: AC
  - elapsed: 0.3763784760000135
    environment: g++
    memory: 70.468
    name: random_03
    status: AC
  - elapsed: 0.33324451299995417
    environment: g++
    memory: 54.328
    name: random_04
    status: AC
