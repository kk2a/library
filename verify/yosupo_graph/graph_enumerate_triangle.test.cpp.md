...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_graph/graph_enumerate_triangle.test.cpp\"\n\
    ...
    \ H, class F> void enumerate_triangle(const G &g, const F &f) {\n    static_assert(!G::directed,\
...
layout: document
redirect_from:
- /verify/verify/yosupo_graph/graph_enumerate_triangle.test.cpp
- /verify/verify/yosupo_graph/graph_enumerate_triangle.test.cpp.html
