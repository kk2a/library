...
data:
  ...
  - code: "#line 1 \"verify/yosupo_graph/graph_cycle_detection.test.cpp\"\n// competitive-verifier:\
      ...
      \ \"graph/static_graph.hpp\"\n\n\n\n#line 1 \"graph/detail/direct_static_adjacency_storage.hpp\"\
      ...
      \n\nnamespace kk2::graph::detail {\n\n// The representation-specific graph classes\
      \ inherit this base.  Operations\n// here only depend on the public graph interface,\
      \ so they are shared by\n// dynamic/static and direct/compact graphs alike.\n\
      template <class T, bool is_directed, bool is_static, bool is_adjacency_list\
      \ = true>\nstruct GraphBase {\n  public:\n    // Types and compile-time graph\
      \ properties.\n    using value_type = T;\n    using edge_type = _Edge<T>;\n\
      ...
      \ k) { return Storage::view(head, &edges, k); }\n\n    auto operator[](int k)\
      \ const { return Storage::view(std::as_const(head), &edges, k); }\n\n    auto\
      \ edge_ids(int k) const\n        requires requires { std::declval<const Storage\
      \ &>().edge_ids(head, k); }\n    {\n        return static_cast<const Storage\
      \ &>(*this).edge_ids(head, k);\n    }\n\n    void swap_edges(int v, int i, int\
      \ j) { Storage::swap_edges(head, v, i, j); }\n    void edge_clear() { *this\
      \ = StaticAdjacencyListBase(num_vertices()); }\n\n    template <OutputStream\
      ...
      \  private:\n    template <InputStream IStream> void _input(IStream &is, int\
      \ m, bool oneindexed) {\n        edges.clear();\n        edges.reserve(m);\n\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002373894999998072
    environment: g++
    memory: 3.768
    name: example_00
    status: AC
  - elapsed: 0.0021158499999955893
    environment: g++
    memory: 3.588
    name: example_01
    status: AC
  - elapsed: 0.002110698000002742
    environment: g++
    memory: 3.736
    name: example_02
    status: AC
  - elapsed: 0.0021427750000029278
    environment: g++
    memory: 3.8
    name: example_03
    status: AC
  - elapsed: 0.002093985999998438
    environment: g++
    memory: 3.772
    name: example_04
    status: AC
  - elapsed: 0.24619961500000187
    environment: g++
    memory: 75.068
    name: long_cycle_00
    status: AC
  - elapsed: 0.24864039999999932
    environment: g++
    memory: 79.048
    name: long_cycle_01
    status: AC
  - elapsed: 0.03131266999999838
    environment: g++
    memory: 12.812
    name: long_cycle_02
    status: AC
  - elapsed: 0.13070013499999789
    environment: g++
    memory: 21.136
    name: random_00
    status: AC
  - elapsed: 0.12567197500000304
    environment: g++
    memory: 21.808
    name: random_01
    status: AC
  - elapsed: 0.09804796899999957
    environment: g++
    memory: 17.48
    name: random_02
    status: AC
  - elapsed: 0.052984233000003655
    environment: g++
    memory: 7.728
    name: random_03
    status: AC
  - elapsed: 0.06557021100000071
    environment: g++
    memory: 9.136
    name: random_04
    status: AC
  - elapsed: 0.12100863300000242
    environment: g++
    memory: 20.036
    name: random_05
    status: AC
  - elapsed: 0.07582321499999978
    environment: g++
    memory: 15.408
    name: random_06
    status: AC
  - elapsed: 0.015408706000002326
    environment: g++
    memory: 4.656
    name: random_07
    status: AC
  - elapsed: 0.0926023059999963
    environment: g++
    memory: 16.524
    name: random_08
    status: AC
  - elapsed: 0.05432308399999641
    environment: g++
    memory: 11.356
    name: random_09
    status: AC
  - elapsed: 0.08755479300000246
    environment: g++
    memory: 18.132
    name: random_dense_00
    status: AC
  - elapsed: 0.09204612699999615
    environment: g++
    memory: 18.224
    name: random_dense_01
    status: AC
  - elapsed: 0.09406460400000327
    environment: g++
    memory: 19.616
    name: random_dense_02
    status: AC
  - elapsed: 0.1752097470000038
    environment: g++
    memory: 20.284
    name: tree_00
    status: AC
  - elapsed: 0.2068781189999953
    environment: g++
    memory: 23.324
    name: tree_01
    status: AC
  - elapsed: 0.024234690999996644
    environment: g++
    memory: 5.804
    name: tree_02
    status: AC
  - elapsed: 0.15331765499999506
    environment: g++
    memory: 20.236
    name: unicyclic_00
    status: AC
  - elapsed: 0.14891359000000648
    environment: g++
    memory: 23.388
    name: unicyclic_01
    status: AC
  - elapsed: 0.020669327999996767
    environment: g++
    memory: 5.808
    name: unicyclic_02
    status: AC
