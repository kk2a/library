...
data:
  ...
  - code: "#line 1 \"verify/yosupo_graph/tree_vertex_add_subtree_sum_2.test.cpp\"\n\
      ...
      \ data;\n\n    T sum(int r) {\n        T s{};\n        for (; r > 0; r -= r\
      \ & -r) s += data[r - 1];\n        return s;\n    }\n};\n\n} // namespace kk2\n\
      \n\n#line 8 \"verify/yosupo_graph/tree_vertex_add_subtree_sum_2.test.cpp\"\n\
      using namespace std;\n\nint main() {\n    int n, q;\n    kin >> n >> q;\n  \
      \  vc<int> a(n);\n    vc<int> p(n - 1);\n    kin >> a >> p;\n    kk2::AdjList\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0028106860000036704
    environment: g++
    memory: 3.776
    name: example_00
    status: AC
  - elapsed: 0.734651418999988
    environment: g++
    memory: 113.032
    name: line_00
    status: AC
  - elapsed: 0.7414248749999786
    environment: g++
    memory: 112.868
    name: line_01
    status: AC
  - elapsed: 1.0066180459999998
    environment: g++
    memory: 63.816
    name: max_random_00
    status: AC
  - elapsed: 1.0252642209999863
    environment: g++
    memory: 63.856
    name: max_random_01
    status: AC
  - elapsed: 1.0067856329999927
    environment: g++
    memory: 63.876
    name: max_random_02
    status: AC
  - elapsed: 0.7744038269999862
    environment: g++
    memory: 50.54
    name: random_00
    status: AC
  - elapsed: 0.9169383729999936
    environment: g++
    memory: 59.336
    name: random_01
    status: AC
  - elapsed: 0.1767967479999868
    environment: g++
    memory: 10.044
    name: random_02
    status: AC
  - elapsed: 0.7095073919999777
    environment: g++
    memory: 55.368
    name: random_03
    status: AC
  - elapsed: 0.47060045899999636
    environment: g++
    memory: 38.824
    name: random_04
    status: AC
  - elapsed: 0.003438472999988562
    environment: g++
    memory: 3.88
    name: small_00
    status: AC
  - elapsed: 0.00264700200000334
    environment: g++
    memory: 3.736
    name: small_01
    status: AC
  - elapsed: 0.0026629980000052456
    environment: g++
    memory: 3.584
    name: small_02
    status: AC
  - elapsed: 0.0037136230000101023
    environment: g++
    memory: 3.94
    name: small_03
    status: AC
  - elapsed: 0.002930157999998073
    environment: g++
    memory: 3.916
    name: small_04
    status: AC
