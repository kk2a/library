...
data:
  ...
  - code: "#line 1 \"verify/yosupo_graph/tree_lca_static.test.cpp\"\n// competitive-verifier:\
      ...
      \ = Edge<E> && requires(const E &e) { e.cost; };\n\ntemplate <class G>\nconcept\
      \ Graph = requires(const G &g, int v) {\n    typename G::value_type;\n    {\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.5165854139999908
    environment: g++
    memory: 81.736
    name: almost_line_00
    status: AC
  - elapsed: 0.5277326869999968
    environment: g++
    memory: 81.756
    name: almost_line_01
    status: AC
  - elapsed: 0.7882707229999824
    environment: g++
    memory: 42.66
    name: binary_00
    status: AC
  - elapsed: 0.8069420280000088
    environment: g++
    memory: 42.7
    name: binary_01
    status: AC
  - elapsed: 0.7972509969999919
    environment: g++
    memory: 42.7
    name: binary_02
    status: AC
  - elapsed: 0.002692552000013393
    environment: g++
    memory: 3.764
    name: example_00
    status: AC
  - elapsed: 0.3993497279999758
    environment: g++
    memory: 96.112
    name: line_00
    status: AC
  - elapsed: 0.44657216999999605
    environment: g++
    memory: 112.632
    name: line_01
    status: AC
  - elapsed: 0.13294957799999452
    environment: g++
    memory: 16.148
    name: line_02
    status: AC
  - elapsed: 0.31411849799999914
    environment: g++
    memory: 104.34
    name: line_03
    status: AC
  - elapsed: 0.23078275999998255
    environment: g++
    memory: 69.348
    name: line_04
    status: AC
  - elapsed: 0.4955704640000249
    environment: g++
    memory: 120.7
    name: max_line_00
    status: AC
  - elapsed: 0.4954584749999924
    environment: g++
    memory: 120.78
    name: max_line_01
    status: AC
  - elapsed: 0.4957118260000186
    environment: g++
    memory: 120.78
    name: max_line_02
    status: AC
  - elapsed: 0.6768882069999904
    environment: g++
    memory: 42.916
    name: max_random_00
    status: AC
  - elapsed: 0.7092120629999954
    environment: g++
    memory: 42.696
    name: max_random_01
    status: AC
  - elapsed: 0.7440678279999986
    environment: g++
    memory: 42.696
    name: max_random_02
    status: AC
  - elapsed: 0.4516748280000229
    environment: g++
    memory: 81.94
    name: path_graph_root_centroid_00
    status: AC
  - elapsed: 0.45133533699998907
    environment: g++
    memory: 81.736
    name: path_graph_root_centroid_01
    status: AC
  - elapsed: 0.45224663000001897
    environment: g++
    memory: 81.816
    name: path_graph_root_centroid_02
    status: AC
  - elapsed: 0.5623688070000128
    environment: g++
    memory: 35.728
    name: random_00
    status: AC
  - elapsed: 0.637407335000006
    environment: g++
    memory: 40.48
    name: random_01
    status: AC
  - elapsed: 0.18410916899998142
    environment: g++
    memory: 7.732
    name: random_02
    status: AC
  - elapsed: 0.39625689400000397
    environment: g++
    memory: 37.14
    name: random_03
    status: AC
  - elapsed: 0.27368876599999226
    environment: g++
    memory: 26.06
    name: random_04
    status: AC
