...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/tree_diameter\n\
      ...
      \ {\n    int n;\n    kin >> n;\n    kk2::WAdjList<i64> g(n, n - 1, kin);\n \
      \   auto [d, path] = kk2::tree_diameter(g);\n    kout << d << \" \" << path.size()\
      \ << kendl;\n    kout << path << kendl;\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_graph/tree_diameter.test.cpp\"\n// competitive-verifier:\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0027307619999987764
    environment: g++
    memory: 3.816
    name: example_00
    status: AC
  - elapsed: 0.0023328519999950004
    environment: g++
    memory: 3.8
    name: hack_00
    status: AC
  - elapsed: 0.6269047330000035
    environment: g++
    memory: 138.3
    name: line_00
    status: AC
  - elapsed: 0.7516804960000059
    environment: g++
    memory: 61.372
    name: max_random_00
    status: AC
  - elapsed: 0.7255833269999812
    environment: g++
    memory: 61.496
    name: max_random_01
    status: AC
  - elapsed: 0.5183610480000311
    environment: g++
    memory: 48.74
    name: random_00
    status: AC
  - elapsed: 0.6603664709999748
    environment: g++
    memory: 57.168
    name: random_01
    status: AC
  - elapsed: 0.05673994299996821
    environment: g++
    memory: 9.58
    name: random_02
    status: AC
  - elapsed: 0.6014007260000085
    environment: g++
    memory: 53.204
    name: random_03
    status: AC
  - elapsed: 0.31741982500000177
    environment: g++
    memory: 35.572
    name: random_04
    status: AC
  - elapsed: 0.002855550000049334
    environment: g++
    memory: 3.804
    name: small_random_00
    status: AC
  - elapsed: 0.002361125999982505
    environment: g++
    memory: 3.804
    name: small_random_01
    status: AC
  - elapsed: 0.002426043000014033
    environment: g++
    memory: 3.796
    name: small_random_02
    status: AC
  - elapsed: 0.0023791429999846514
    environment: g++
    memory: 3.804
    name: small_random_03
    status: AC
  - elapsed: 0.002288055000008171
    environment: g++
    memory: 3.728
    name: small_random_04
    status: AC
  - elapsed: 0.6442137469999807
    environment: g++
    memory: 60.104
    name: uni_00
    status: AC
