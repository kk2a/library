...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/shortest_path\n\
      ...
      \n    if (prev[t].to == -1) {\n        kout << -1 << \"\\n\";\n        return\
      \ 0;\n    }\n\n    std::vector<int> path;\n    for (int now = t; now != -1;\
      \ now = prev[now].to) path.emplace_back(now);\n\n    kout << dist[t] << \" \"\
      \ << path.size() - 1 << \"\\n\";\n    for (int i = path.size() - 1; i; --i)\
      \ kout << path[i] << \" \" << path[i - 1] << \"\\n\";\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_graph/graph_shortest_path.test.cpp\"\n// competitive-verifier:\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.5764296720000033
    environment: g++
    memory: 45.904
    name: almost_line_00
    status: AC
  - elapsed: 0.5467995470000062
    environment: g++
    memory: 45.912
    name: almost_line_01
    status: AC
  - elapsed: 0.5721502680000015
    environment: g++
    memory: 46.276
    name: almost_line_02
    status: AC
  - elapsed: 0.002896233999990727
    environment: g++
    memory: 3.608
    name: example_00
    status: AC
  - elapsed: 0.0023676699999981565
    environment: g++
    memory: 3.66
    name: example_01
    status: AC
  - elapsed: 0.481639536000003
    environment: g++
    memory: 36.536
    name: grid_random_00
    status: AC
  - elapsed: 0.6970204859999996
    environment: g++
    memory: 38.544
    name: grid_swirl_00
    status: AC
  - elapsed: 0.6825257849999957
    environment: g++
    memory: 58.2
    name: line_00
    status: AC
  - elapsed: 0.2062940409999925
    environment: g++
    memory: 30.0
    name: max_dense_long_00
    status: AC
  - elapsed: 0.1934419859999963
    environment: g++
    memory: 29.872
    name: max_dense_random_00
    status: AC
  - elapsed: 0.19497395000000495
    environment: g++
    memory: 29.872
    name: max_dense_random_01
    status: AC
  - elapsed: 0.15153876699999103
    environment: g++
    memory: 29.812
    name: max_dense_zero_00
    status: AC
  - elapsed: 0.40164175999998974
    environment: g++
    memory: 45.892
    name: max_sparse_random_00
    status: AC
  - elapsed: 0.6965521810000013
    environment: g++
    memory: 46.664
    name: max_sparse_random_01
    status: AC
  - elapsed: 0.6780471260000098
    environment: g++
    memory: 46.608
    name: max_sparse_random_02
    status: AC
  - elapsed: 0.9654547410000021
    environment: g++
    memory: 62.396
    name: max_star_00
    status: AC
  - elapsed: 1.090292126999998
    environment: g++
    memory: 60.52
    name: max_star_01
    status: AC
  - elapsed: 0.002894402000009677
    environment: g++
    memory: 3.768
    name: small_00
    status: AC
  - elapsed: 0.0023466080000105194
    environment: g++
    memory: 3.604
    name: small_01
    status: AC
  - elapsed: 0.002342853000016021
    environment: g++
    memory: 3.828
    name: small_02
    status: AC
  - elapsed: 0.0022997769999903994
    environment: g++
    memory: 3.604
    name: small_03
    status: AC
  - elapsed: 0.002338686000001644
    environment: g++
    memory: 3.656
    name: small_04
    status: AC
  - elapsed: 0.32463450900002044
    environment: g++
    memory: 47.632
    name: sparse_random_00
    status: AC
  - elapsed: 0.342542648999995
    environment: g++
    memory: 51.736
    name: sparse_random_01
    status: AC
  - elapsed: 0.3512574220000033
    environment: g++
    memory: 30.552
    name: sparse_random_02
    status: AC
  - elapsed: 1.0065566680000018
    environment: g++
    memory: 56.836
    name: spfa_killer_00
    status: AC
  - elapsed: 0.0029080699999894932
    environment: g++
    memory: 3.66
    name: wrong_dijkstra_handmade_00
    status: AC
  - elapsed: 0.7890129520000073
    environment: g++
    memory: 46.436
    name: wrong_dijkstra_killer_00
    status: AC
  - elapsed: 1.2160045199999843
    environment: g++
    memory: 52.332
