...
data:
  ...
  - code: "#line 1 \"verify/yosupo_graph/graph_shortest_path.test.cpp\"\n// competitive-verifier:\
      ...
      \ = kk2::dijkstra(g, s);\n\n    if (prev[t].to == -1) {\n        kout << -1\
      \ << \"\\n\";\n        return 0;\n    }\n\n    std::vector<int> path;\n    for\
      \ (int now = t; now != -1; now = prev[now].to) path.emplace_back(now);\n\n \
      \   kout << dist[t] << \" \" << path.size() - 1 << \"\\n\";\n    for (int i\
      \ = path.size() - 1; i; --i) kout << path[i] << \" \" << path[i - 1] << \"\\\
      n\";\n\n    return 0;\n}\n"
    name: bundled
  isFailed: false
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.590867853000006
    environment: g++
    memory: 43.544
    name: almost_line_00
    status: AC
  - elapsed: 0.5407203030000005
    environment: g++
    memory: 43.544
    name: almost_line_01
    status: AC
  - elapsed: 0.5411447139999979
    environment: g++
    memory: 43.608
    name: almost_line_02
    status: AC
  - elapsed: 0.00260313800000489
    environment: g++
    memory: 3.82
    name: example_00
    status: AC
  - elapsed: 0.0021223319999990053
    environment: g++
    memory: 3.816
    name: example_01
    status: AC
  - elapsed: 0.3915702259999989
    environment: g++
    memory: 35.364
    name: grid_random_00
    status: AC
  - elapsed: 0.5933713240000031
    environment: g++
    memory: 37.352
    name: grid_swirl_00
    status: AC
  - elapsed: 0.7647621440000023
    environment: g++
    memory: 58.244
    name: line_00
    status: AC
  - elapsed: 0.16253275699999392
    environment: g++
    memory: 27.192
    name: max_dense_long_00
    status: AC
  - elapsed: 0.16251241900000934
    environment: g++
    memory: 27.068
    name: max_dense_random_00
    status: AC
  - elapsed: 0.16611264299999107
    environment: g++
    memory: 27.032
    name: max_dense_random_01
    status: AC
  - elapsed: 0.1301391960000018
    environment: g++
    memory: 26.88
    name: max_dense_zero_00
    status: AC
  - elapsed: 0.3740198419999956
    environment: g++
    memory: 43.092
    name: max_sparse_random_00
    status: AC
  - elapsed: 0.693863444999991
    environment: g++
    memory: 44.724
    name: max_sparse_random_01
    status: AC
  - elapsed: 0.7466318700000016
    environment: g++
    memory: 44.756
    name: max_sparse_random_02
    status: AC
  - elapsed: 1.2695956430000024
    environment: g++
    memory: 62.288
    name: max_star_00
    status: AC
  - elapsed: 1.2172840440000101
    environment: g++
    memory: 62.228
    name: max_star_01
    status: AC
  - elapsed: 0.0028788230000031945
    environment: g++
    memory: 3.768
    name: small_00
    status: AC
  - elapsed: 0.002481755000005137
    environment: g++
    memory: 3.804
    name: small_01
    status: AC
  - elapsed: 0.00240682900000877
    environment: g++
    memory: 3.82
    name: small_02
    status: AC
  - elapsed: 0.0023461600000018734
    environment: g++
    memory: 3.78
    name: small_03
    status: AC
  - elapsed: 0.002352810000004979
    environment: g++
    memory: 3.824
    name: small_04
    status: AC
  - elapsed: 0.3304055769999934
    environment: g++
    memory: 46.652
    name: sparse_random_00
    status: AC
  - elapsed: 0.3212988370000005
    environment: g++
    memory: 50.948
    name: sparse_random_01
    status: AC
  - elapsed: 0.3840977549999991
    environment: g++
    memory: 25.756
    name: sparse_random_02
    status: AC
  - elapsed: 1.0474877130000095
    environment: g++
    memory: 53.54
    name: spfa_killer_00
    status: AC
  - elapsed: 0.002678125999992176
    environment: g++
    memory: 3.624
    name: wrong_dijkstra_handmade_00
    status: AC
  - elapsed: 0.7942034860000007
    environment: g++
    memory: 46.444
    name: wrong_dijkstra_killer_00
    status: AC
  - elapsed: 1.2136750660000075
    environment: g++
    memory: 51.008
