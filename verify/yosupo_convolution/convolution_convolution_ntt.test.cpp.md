...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_convolution/convolution_convolution_ntt.test.cpp\"\
    ...
    }\n\n\n#line 6 \"verify/yosupo_convolution/convolution_convolution_ntt.test.cpp\"\
    \nusing namespace std;\n\nint main() {\n    int n, m;\n    cin >> n >> m;\n  \
  ...
  verifiedWith: []
documentation_of: verify/yosupo_convolution/convolution_convolution_ntt.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_convolution/convolution_convolution_ntt.test.cpp
- /verify/verify/yosupo_convolution/convolution_convolution_ntt.test.cpp.html
