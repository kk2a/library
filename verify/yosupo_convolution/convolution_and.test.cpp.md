...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/bitwise_and_convolution\n\
      \n#include \"../../convolution/convolution_and.hpp\"\n\n#include \"../../modint/mont.hpp\"\
      \n#include \"../../template/template.hpp\"\nusing namespace std;\n\nint main()\
      \ {\n    int n;\n    kin >> n;\n    vc<kk2::mont998> a(1 << n), b(1 << n);\n\
      \    kin >> a >> b;\n    kout << kk2::convolution_and(a, b) << kendl;\n\n  \
      \  return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_convolution/convolution_and.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/bitwise_and_convolution\n\n#line 1\
      \ \"convolution/convolution_and.hpp\"\n\n\n\n#include <cassert>\n\n#line 1 \"\
      ...
      \ i <<= 1) {\n        for (int j = 0; j < n; j++) {\n            if ((i & j)\
      \ != 0) a[j] -= a[i ^ j];\n        }\n    }\n}\n\n} // namespace kk2\n\n\n#line\
      \ 7 \"convolution/convolution_and.hpp\"\n\nnamespace kk2 {\n\ntemplate <class\
      \ FPS> FPS convolution_and(FPS &a, const FPS &b) {\n    assert(size(a) == size(b));\n\
      \    int n = int(size(a)); // == int(size(b)\n    if (!n) return {};\n    assert((n\
      \ & -n) == n);\n    FPS c(b.begin(), b.end());\n\n    superset_zeta_transform(a);\n\
      \    superset_zeta_transform(c);\n    for (int i = 0; i < n; i++) a[i] *= c[i];\n\
      \    inverse_superset_zeta_transform(a);\n\n    return a;\n}\n\n} // namespace\
      \ kk2\n\n\n#line 4 \"verify/yosupo_convolution/convolution_and.test.cpp\"\n\n\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 7 \"verify/yosupo_convolution/convolution_and.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    int n;\n    kin >> n;\n    vc<kk2::mont998>\
      \ a(1 << n), b(1 << n);\n    kin >> a >> b;\n    kout << kk2::convolution_and(a,\
      \ b) << kendl;\n\n    return 0;\n}\n"
    name: bundled
  isFailed: false
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.0024252129999950967
    environment: g++
    memory: 3.86
    name: example_00
    status: AC
  - elapsed: 0.701430221999999
    environment: g++
    memory: 19.772
    name: max_random_00
    status: AC
  - elapsed: 0.6911202160000016
    environment: g++
    memory: 19.884
    name: max_random_01
    status: AC
  - elapsed: 0.6926689329999931
    environment: g++
    memory: 19.884
    name: max_random_02
    status: AC
  - elapsed: 0.021618924999998512
    environment: g++
    memory: 4.18
    name: random_00
    status: AC
  - elapsed: 0.04143809599999315
    environment: g++
    memory: 4.576
    name: random_01
    status: AC
  - elapsed: 0.16655172000000107
    environment: g++
    memory: 7.524
    name: random_02
    status: AC
  - elapsed: 0.0024031529999888335
    environment: g++
    memory: 3.812
    name: small_00
    status: AC
  - elapsed: 0.0021174199999904886
    environment: g++
    memory: 3.852
    name: small_01
    status: AC
  - elapsed: 0.002161686999997414
    environment: g++
    memory: 3.824
    name: small_02
    status: AC
  - elapsed: 0.001930022999999892
    environment: g++
    memory: 3.68
    name: tiny_00
    status: AC
  - elapsed: 0.0018954690000043684
    environment: g++
    memory: 3.752
    name: tiny_01
    status: AC
  - elapsed: 0.001963596999999595
    environment: g++
    memory: 3.896
    name: tiny_02
    status: AC
