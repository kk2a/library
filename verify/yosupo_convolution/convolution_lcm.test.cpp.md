...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/lcm_convolution\n\
      \n#include \"../../convolution/convolution_lcm.hpp\"\n\n#include \"../../modint/mont.hpp\"\
      ...
      \ 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_convolution/convolution_lcm.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/lcm_convolution\n\n#line 1 \"convolution/convolution_lcm.hpp\"\
      ...
      \n\n#line 4 \"verify/yosupo_convolution/convolution_lcm.test.cpp\"\n\n#line\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 7 \"verify/yosupo_convolution/convolution_lcm.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    int n;\n    kin >> n;\n    vc<kk2::mont998>\
      \ a(n + 1), b(n + 1);\n    rep(i, n) kin >> a[i + 1];\n    rep(i, n) kin >>\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002397654000020566
    environment: g++
    memory: 3.884
    name: all_zero_00
    status: AC
  - elapsed: 0.002126336000003448
    environment: g++
    memory: 3.884
    name: example_00
    status: AC
  - elapsed: 0.418748872000009
    environment: g++
    memory: 19.512
    name: max_random_00
    status: AC
  - elapsed: 0.4231232019999993
    environment: g++
    memory: 19.452
    name: max_random_01
    status: AC
  - elapsed: 0.42194677000000524
    environment: g++
    memory: 19.504
    name: near_prime_00
    status: AC
  - elapsed: 0.42411230400000477
    environment: g++
    memory: 19.54
    name: near_prime_01
    status: AC
  - elapsed: 0.42104114199997866
    environment: g++
    memory: 19.536
    name: near_prime_02
    status: AC
  - elapsed: 0.4344783710000115
    environment: g++
    memory: 19.368
    name: near_prime_squared_00
    status: AC
  - elapsed: 0.41779000600001837
    environment: g++
    memory: 19.288
    name: near_prime_squared_01
    status: AC
  - elapsed: 0.4177161210000122
    environment: g++
    memory: 19.344
    name: near_prime_squared_02
    status: AC
  - elapsed: 0.16030587399998808
    environment: g++
    memory: 9.732
    name: random_00
    status: AC
  - elapsed: 0.19409502199999906
    environment: g++
    memory: 11.764
    name: random_01
    status: AC
  - elapsed: 0.23997326099998872
    environment: g++
    memory: 12.764
    name: random_02
    status: AC
  - elapsed: 0.0024193130000185192
    environment: g++
    memory: 3.912
    name: small_00
    status: AC
  - elapsed: 0.002130004000008512
    environment: g++
    memory: 3.888
    name: small_01
    status: AC
  - elapsed: 0.0020117210000023533
    environment: g++
    memory: 3.812
    name: small_02
    status: AC
  - elapsed: 0.0019475100000079237
    environment: g++
    memory: 3.912
    name: small_03
    status: AC
  - elapsed: 0.0019245020000084878
    environment: g++
    memory: 3.828
    name: small_04
    status: AC
  - elapsed: 0.0020662960000095154
    environment: g++
    memory: 3.828
    name: small_05
    status: AC
  - elapsed: 0.0019615060000148787
    environment: g++
    memory: 3.864
    name: small_06
    status: AC
  - elapsed: 0.0019574599999998554
    environment: g++
    memory: 3.884
    name: small_07
    status: AC
  - elapsed: 0.0019808700000112367
    environment: g++
    memory: 3.828
    name: small_08
    status: AC
  - elapsed: 0.0019416350000085458
    environment: g++
    memory: 3.888
    name: small_09
    status: AC
  - elapsed: 0.0019145499999808635
    environment: g++
    memory: 3.856
    name: small_10
    status: AC
  - elapsed: 0.002078374999996413
    environment: g++
    memory: 3.884
    name: small_11
    status: AC
  - elapsed: 0.0019408439999892835
    environment: g++
    memory: 3.864
    name: small_12
    status: AC
  - elapsed: 0.00187871400001427
    environment: g++
    memory: 3.852
    name: small_13
    status: AC
  - elapsed: 0.0019147049999901355
    environment: g++
    memory: 3.88
    name: small_14
    status: AC
  - elapsed: 0.0019350009999925533
    environment: g++
    memory: 3.868
    name: small_15
    status: AC
