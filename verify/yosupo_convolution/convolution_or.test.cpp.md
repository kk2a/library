...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/bitwise_and_convolution\n\
      ...
      \ c << kendl;\n\n    return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_convolution/convolution_or.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/bitwise_and_convolution\n\n#line 1\
      \ \"convolution/convolution_or.hpp\"\n\n\n\n#include <cassert>\n\n#line 1 \"\
      ...
      \ const S &b) { return (a > b ? a = b, 1 : 0); }\n\n\n#line 6 \"verify/yosupo_convolution/convolution_or.test.cpp\"\
      \nusing namespace std;\n\nint main() {\n    int n;\n    kin >> n;\n    vc<kk2::mont998>\
      \ a(1 << n), b(1 << n);\n    rep (i, 1 << n) kin >> a[~i & ((1 << n) - 1)];\n\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.002702368000001343
    environment: g++
    memory: 3.748
    name: example_00
    status: AC
  - elapsed: 0.8242658230000046
    environment: g++
    memory: 19.792
    name: max_random_00
    status: AC
  - elapsed: 0.8230390040000017
    environment: g++
    memory: 19.824
    name: max_random_01
    status: AC
  - elapsed: 0.8198182199999948
    environment: g++
    memory: 19.792
    name: max_random_02
    status: AC
  - elapsed: 0.025647521999999867
    environment: g++
    memory: 4.204
    name: random_00
    status: AC
  - elapsed: 0.04861995799999619
    environment: g++
    memory: 4.456
    name: random_01
    status: AC
  - elapsed: 0.19698569100000185
    environment: g++
    memory: 7.54
    name: random_02
    status: AC
  - elapsed: 0.0026216640000029656
    environment: g++
    memory: 3.748
    name: small_00
    status: AC
  - elapsed: 0.002166957000000025
    environment: g++
    memory: 3.712
    name: small_01
    status: AC
  - elapsed: 0.0023162450000029366
    environment: g++
    memory: 3.772
    name: small_02
    status: AC
  - elapsed: 0.0021502359999985288
    environment: g++
    memory: 3.744
    name: tiny_00
    status: AC
  - elapsed: 0.002158770999997728
    environment: g++
    memory: 3.764
    name: tiny_01
    status: AC
  - elapsed: 0.0022100070000021788
    environment: g++
    memory: 3.788
    name: tiny_02
    status: AC
