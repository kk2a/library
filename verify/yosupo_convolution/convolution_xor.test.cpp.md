...
data:
  ...
  - code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/bitwise_xor_convolution\n\
      ...
      \  return 0;\n}\n"
    name: default
  - code: "#line 1 \"verify/yosupo_convolution/convolution_xor.test.cpp\"\n// competitive-verifier:\
      \ PROBLEM https://judge.yosupo.jp/problem/bitwise_xor_convolution\n\n#line 1\
      \ \"convolution/convolution_xor.hpp\"\n\n\n\n#include <cassert>\n\n#line 1 \"\
  ...
  requiredBy: []
  testcases:
  - elapsed: 0.00260613599999715
    environment: g++
    memory: 3.768
    name: example_00
    status: AC
  - elapsed: 0.17807977499998628
    environment: g++
    memory: 4.072
    name: large_00
    status: AC
  - elapsed: 0.3763062360000049
    environment: g++
    memory: 4.516
    name: large_01
    status: AC
  - elapsed: 1.6710660729999915
    environment: g++
    memory: 7.588
    name: large_02
    status: AC
  - elapsed: 7.394083530000017
    environment: g++
    memory: 19.828
    name: max_random_00
    status: AC
  - elapsed: 7.384980425000009
    environment: g++
    memory: 19.828
    name: max_random_01
    status: AC
  - elapsed: 7.38195518400002
    environment: g++
    memory: 19.828
    name: max_random_02
    status: AC
  - elapsed: 0.0025538950000054683
    environment: g++
    memory: 3.768
    name: small_00
    status: AC
  - elapsed: 0.0022342799999819363
    environment: g++
    memory: 3.62
    name: small_01
    status: AC
  - elapsed: 0.0028833199999951376
    environment: g++
    memory: 3.76
    name: small_02
    status: AC
  - elapsed: 0.002086453000003985
    environment: g++
    memory: 3.732
    name: tiny_00
    status: AC
  - elapsed: 0.0020533310000132587
    environment: g++
    memory: 3.764
    name: tiny_01
    status: AC
  - elapsed: 0.0021032749999960743
    environment: g++
    memory: 3.744
    name: tiny_02
    status: AC
