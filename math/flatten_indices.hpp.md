...
data:
  ...
  - code: "#line 1 \"math/flatten_indices.hpp\"\n\n\n\n#include <vector>\n\nnamespace\
      ...
      \      return -1;\n        return index + _inner_dims[i];\n    }\n\n    int\
      \ prev(int index, unsigned int i) const {\n        assert(i < _inner_dims.size()\
      \ - 1);\n        if (index % _inner_dims[i + 1] / _inner_dims[i] == 0) return\
      \ -1;\n        return index - _inner_dims[i];\n    }\n\n    int size() const\
      \ { return _inner_dims.back(); }\n};\n\n} // namespace kk2\n\n\n"
    name: bundled
  isFailed: false
