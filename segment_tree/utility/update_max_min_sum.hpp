#ifndef SEGMENT_TREE_UTILITY_UPDATE_MAX_MIN_SUM_HPP
#define SEGMENT_TREE_UTILITY_UPDATE_MAX_MIN_SUM_HPP 1
...
#endif // SEGMENT_TREE_UTILITY_UPDATE_MAX_MIN_SUM_HPP
